...
import net.minecraft.client.gui.鬼YesNo;
...
class GuiSlotShaders extends GuiSlot
{
    ...
    final 鬼Shaders shadersGui;

    public GuiSlotShaders(鬼Shaders par1GuiShaders, int width, int height, int top, int bottom, int slotHeight)
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        鬼YesNo guiyesno = new 鬼YesNo(guiyesnocallback, s4, s5, 0);
