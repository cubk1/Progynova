...
public class 鬼Shaders extends 鬼ScreenOF
{
    protected 鬼Screen parentGui;
    ...
    public 鬼Shaders(鬼Screen par1GuiScreen, GameSettings par2GameSettings)
    {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new 鬼ButtonEnumShaderOption(EnumShaderOption.ANTIALIASING, k, 0 * i1 + l, i, j));
        this.buttonList.add(new 鬼ButtonEnumShaderOption(EnumShaderOption.NORMAL_MAP, k, 1 * i1 + l, i, j));
        this.buttonList.add(new 鬼ButtonEnumShaderOption(EnumShaderOption.SPECULAR_MAP, k, 2 * i1 + l, i, j));
        this.buttonList.add(new 鬼ButtonEnumShaderOption(EnumShaderOption.RENDER_RES_MUL, k, 3 * i1 + l, i, j));
        this.buttonList.add(new 鬼ButtonEnumShaderOption(EnumShaderOption.SHADOW_RES_MUL, k, 4 * i1 + l, i, j));
        this.buttonList.add(new 鬼ButtonEnumShaderOption(EnumShaderOption.HAND_DEPTH_MUL, k, 5 * i1 + l, i, j));
        this.buttonList.add(new 鬼ButtonEnumShaderOption(EnumShaderOption.OLD_HAND_LIGHT, k, 6 * i1 + l, i, j));
        this.buttonList.add(new 鬼ButtonEnumShaderOption(EnumShaderOption.OLD_LIGHTING, k, 7 * i1 + l, i, j));
        int k1 = Math.min(150, j1 / 2 - 10);
        int l1 = j1 / 4 - k1 / 2;
        int i2 = this.height - 25;
        this.buttonList.add(new 鬼Button(201, l1, i2, k1 - 22 + 1, j, Lang.get("of.options.shaders.shadersFolder")));
        this.buttonList.add(new 鬼ButtonDownloadShaders(210, l1 + k1 - 22 - 1, i2));
        this.buttonList.add(new 鬼Button(202, j1 / 4 * 3 - k1 / 2, this.height - 25, k1, j, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new 鬼Button(203, k, this.height - 25, i, j, Lang.get("of.options.shaders.shaderOptions")));
        this.updateButtons();
    }
    ...
    protected void actionPerformed(鬼Button button)
    {
        this.actionPerformed(button, false);
    }

    protected void actionPerformedRightClick(鬼Button button)
    {
        this.actionPerformed(button, true);
    }

    private void actionPerformed(鬼Button button, boolean rightClick)
    {
        if (button.enabled)
        {
            if (!(button instanceof 鬼ButtonEnumShaderOption))
            {
                if (!rightClick)
                {
                    switch (button.id)
                    {
                        ...
                        case 203:
                            鬼ShaderOptions guishaderoptions = new 鬼ShaderOptions(this, Config.getGameSettings());
            ...
            {
                鬼ButtonEnumShaderOption guibuttonenumshaderoption = (鬼ButtonEnumShaderOption)button;
