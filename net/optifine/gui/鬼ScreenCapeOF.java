...
public class 鬼ScreenCapeOF extends 鬼ScreenOF
{
    ...
    private 鬼ButtonOF buttonCopyLink;
    ...
    public void initGui()
    {
        ...
        i = i + 2;
        this.buttonList.add(new 鬼ButtonOF(210, this.width / 2 - 155, this.height / 6 + 24 * (i >> 1), 150, 20, I18n.format("of.options.capeOF.openEditor", new Object[0])));
        this.buttonList.add(new 鬼ButtonOF(220, this.width / 2 - 155 + 160, this.height / 6 + 24 * (i >> 1), 150, 20, I18n.format("of.options.capeOF.reloadCape", new Object[0])));
        i = i + 6;
        this.buttonCopyLink = new 鬼ButtonOF(230, this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), 200, 20, I18n.format("of.options.capeOF.copyEditorLink", new Object[0]));
        this.buttonCopyLink.visible = this.linkUrl != null;
        this.buttonList.add(this.buttonCopyLink);
        i = i + 4;
        this.buttonList.add(new 鬼ButtonOF(200, this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), I18n.format("gui.done", new Object[0])));
    }
        ...
        if (button.enabled)
        {
            ...
            if (button.id == 220)
            {
                ...
                if (this.mc.宇轩游玩者 != null)
                {
                    ...
                    this.mc.宇轩游玩者.setReloadCapeTimeMs(j);
                }
            }
