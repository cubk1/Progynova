...
public class 鬼Message extends 鬼Screen
{
    ...
    public 鬼Message(鬼Screen parentScreen, String line1, String line2)
    {
    ...
    public void initGui()
    {
        this.buttonList.add(new 鬼OptionButton(0, this.width / 2 - 74, this.height / 6 + 96, this.confirmButtonText));
