...
public class PlayerItemModel
{
    ...
    public void render(ModelBiped modelBiped, AbstractClientPlayer player, float scale, float partialTicks)
    {
        ...
        {
            texturemanager.绑定手感(player.getLocationSkin());
        }
        else if (this.textureLocation != null)
        {
            if (this.texture == null && this.textureImage != null)
            {
                ...
                我的手艺.得到我的手艺().得到手感经理().loadTexture(this.textureLocation, this.texture);
            }

            texturemanager.绑定手感(this.textureLocation);
        }
        else
        {
            texturemanager.绑定手感(this.locationMissing);
        }
