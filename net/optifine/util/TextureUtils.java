...
public class TextureUtils
{
    ...
    {
        return 我的手艺.得到我的手艺().getTextureMapBlocks();
    }
    ...
    public static int getGLMaximumTextureSize()
    {
        ...
        {
            光照状态经理.glTexImage2D(32868, 0, 6408, i, i, 0, 6408, 5121, (IntBuffer)null);
            int j = GL11.glGetError();
            int k = 光照状态经理.glGetTexLevelParameteri(32868, 0, 4096);
