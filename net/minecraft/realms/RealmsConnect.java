        ...
        (new Thread("Realms-connect-task")
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    RealmsConnect.this.connection = NetworkManager.createNetworkManagerAndConnect(inetaddress, p_connect_2_, 我的手艺.得到我的手艺().游戏一窝.isUsingNativeTransport());
                    ...
                    RealmsConnect.this.connection.setNetHandler(new NetHandlerLoginClient(RealmsConnect.this.connection, 我的手艺.得到我的手艺(), RealmsConnect.this.onlineScreen.getProxy()));
                    ...
                    RealmsConnect.this.connection.sendPacket(new C00PacketLoginStart(我的手艺.得到我的手艺().getSession().getProfile()));
                }
