...
public class RealmsScreen
{
    ...
    protected 我的手艺 宇轩的世界;
    public int width;
    public int height;
    private 鬼ScreenRealmsProxy proxy = new 鬼ScreenRealmsProxy(this);

    public 鬼ScreenRealmsProxy getProxy()
    {
        return this.proxy;
    }
    ...
    public void init(我的手艺 p_init_1_, int p_init_2_, int p_init_3_)
    {
    }
    ...
    {
        鬼.drawScaledCustomSizeModalRect(p_blit_0_, p_blit_1_, p_blit_2_, p_blit_3_, p_blit_4_, p_blit_5_, p_blit_6_, p_blit_7_, p_blit_8_, p_blit_9_);
    }
    ...
    {
        鬼.绘制模态矩形以自定义大小纹理(p_blit_0_, p_blit_1_, p_blit_2_, p_blit_3_, p_blit_4_, p_blit_5_, p_blit_6_, p_blit_7_);
    }
    ...
    {
        return new RealmsAnvilLevelStorageSource(我的手艺.得到我的手艺().getSaveLoader());
    }
