...
public class IntegratedServer extends MinecraftServer
{
    ...
    public IntegratedServer(我的手艺 mcIn, String folderName, String worldName, WorldSettings settings)
    {
    ...
    protected void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, String worldNameIn2)
    {
        ...
        if (flag)
        {
            ...
            {
                this.setDifficultyForAllWorlds(this.mc.游戏一窝.difficulty);
            }
        }
        else
        {
    ...
    public void tick()
    {
        ...
        this.isGamePaused = 我的手艺.得到我的手艺().getNetHandler() != null && 我的手艺.得到我的手艺().isGamePaused();
        ...
        else
        {
            ...
            if (this.mc.游戏一窝.renderDistanceChunks != this.getConfigurationManager().getViewDistance())
            {
                logger.info("Changing view distance to {}, from {}", new Object[] {Integer.valueOf(this.mc.游戏一窝.renderDistanceChunks), Integer.valueOf(this.getConfigurationManager().getViewDistance())});
                this.getConfigurationManager().setViewDistance(this.mc.游戏一窝.renderDistanceChunks);
            }

            if (this.mc.宇轩の世界 != null)
            {
                WorldInfo worldinfo1 = this.worldServers[0].getWorldInfo();
                WorldInfo worldinfo = this.mc.宇轩の世界.getWorldInfo();
    ...
    {
        return this.mc.宇轩の世界 == null ? this.mc.游戏一窝.difficulty : this.mc.宇轩の世界.getWorldInfo().getDifficulty();
    }
    ...
    public void saveAllWorlds(boolean dontLog)
    {
        if (dontLog)
        {
            ...
            int j = this.mc.游戏一窝.ofAutoSaveTicks;
        ...
        report.getCategory().addCrashSectionCallable("Is Modded", new Callable<String>()
        {
            public String call() throws Exception
            {
                ...
                else
                {
                    ...
                    return !s.equals("vanilla") ? "Definitely; Server brand changed to \'" + s + "\'" : (我的手艺.class.getSigners() == null ? "Very likely; Jar signature invalidated" : "Probably not. Jar signature remains and both client + server brands are untouched.");
                }
            }
        });
        return report;
    ...
    public void setDifficultyForAllWorlds(EnumDifficulty difficulty)
    {
        ...
        if (this.mc.宇轩の世界 != null)
        {
            this.mc.宇轩の世界.getWorldInfo().setDifficulty(difficulty);
        }
    }
    ...
    {
        return 我的手艺.得到我的手艺().isSnooperEnabled();
    }
