...
public class CommandScoreboard extends CommandBase
{
        ...
        else
        {
            ...
            for (String s1 : list1)
            {
                ...
                catch (CommandException commandexception)
                {
                    ...
                    p_175780_1_.增添聊天讯息(chatcomponenttranslation);
                }
            }
    ...
    protected void setTeamOption(ICommandSender sender, String[] args, int index) throws CommandException
    {
        ...
        if (scoreplayerteam != null)
        {
            ...
            else if (args.length == 4)
            {
                ...
                {
                    throw new WrongUsageException("commands.scoreboard.teams.option.noValue", new Object[] {s, joinNiceStringFromCollection(枚举聊天格式.getValidValues(true, false))});
                }
            ...
            else
            {
                ...
                if (s.equalsIgnoreCase("color"))
                {
                    枚举聊天格式 enumchatformatting = 枚举聊天格式.getValueByName(s1);
                    ...
                    scoreplayerteam.setNameSuffix(枚举聊天格式.RESET.toString());
                }
    ...
    protected void listTeams(ICommandSender p_147186_1_, String[] p_147186_2_, int p_147186_3_) throws CommandException
    {
        ...
        if (p_147186_2_.length > p_147186_3_)
        {
            ...
            chatcomponenttranslation.getChatStyle().setColor(枚举聊天格式.DARK_GREEN);
            p_147186_1_.增添聊天讯息(chatcomponenttranslation);
            p_147186_1_.增添聊天讯息(new 交流组分文本(joinNiceString(collection.toArray())));
        }
        else
        {
            ...
            chatcomponenttranslation1.getChatStyle().setColor(枚举聊天格式.DARK_GREEN);
            p_147186_1_.增添聊天讯息(chatcomponenttranslation1);

            for (ScorePlayerTeam scoreplayerteam1 : collection1)
            {
                p_147186_1_.增添聊天讯息(new ChatComponentTranslation("commands.scoreboard.teams.list.entry", new Object[] {scoreplayerteam1.getRegisteredName(), scoreplayerteam1.getTeamName(), Integer.valueOf(scoreplayerteam1.getMembershipCollection().size())}));
            }
        }
    }
    ...
    protected void listObjectives(ICommandSender p_147196_1_) throws CommandException
    {
        ...
        else
        {
            ...
            chatcomponenttranslation.getChatStyle().setColor(枚举聊天格式.DARK_GREEN);
            p_147196_1_.增添聊天讯息(chatcomponenttranslation);

            for (ScoreObjective scoreobjective : collection)
            {
                p_147196_1_.增添聊天讯息(new ChatComponentTranslation("commands.scoreboard.objectives.list.entry", new Object[] {scoreobjective.getName(), scoreobjective.getDisplayName(), scoreobjective.getCriteria().getName()}));
            }
        }
    }
    ...
    protected void listPlayers(ICommandSender p_147195_1_, String[] p_147195_2_, int p_147195_3_) throws CommandException
    {
        ...
        if (p_147195_2_.length > p_147195_3_)
        {
            ...
            chatcomponenttranslation.getChatStyle().setColor(枚举聊天格式.DARK_GREEN);
            p_147195_1_.增添聊天讯息(chatcomponenttranslation);

            for (Score score : map.values())
            {
                p_147195_1_.增添聊天讯息(new ChatComponentTranslation("commands.scoreboard.players.list.player.entry", new Object[] {Integer.valueOf(score.getScorePoints()), score.getObjective().getDisplayName(), score.getObjective().getName()}));
            }
        }
        else
        {
            ...
            chatcomponenttranslation1.getChatStyle().setColor(枚举聊天格式.DARK_GREEN);
            p_147195_1_.增添聊天讯息(chatcomponenttranslation1);
            p_147195_1_.增添聊天讯息(new 交流组分文本(joinNiceString(collection.toArray())));
        }
    }
                    ...
                    if (!args[1].equalsIgnoreCase("empty") && !args[1].equalsIgnoreCase("list") && !args[1].equalsIgnoreCase("remove"))
                    {
                        if (args[1].equalsIgnoreCase("option"))
                        {
                            ...
                            if (args.length == 5)
                            {
                                ...
                                {
                                    return getListOfStringsMatchingLastWord(args, 枚举聊天格式.getValidValues(true, false));
                                }
