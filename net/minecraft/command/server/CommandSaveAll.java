...
public class CommandSaveAll extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        sender.增添聊天讯息(new ChatComponentTranslation("commands.save.start", new Object[0]));
        ...
        try
        {
            ...
            {
                sender.增添聊天讯息(new ChatComponentTranslation("commands.save.flushStart", new Object[0]));
                ...
                sender.增添聊天讯息(new ChatComponentTranslation("commands.save.flushEnd", new Object[0]));
            }
        }
