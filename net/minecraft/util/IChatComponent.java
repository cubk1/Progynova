...
public interface IChatComponent extends Iterable<IChatComponent>
{
    ...
    public static class Serializer implements JsonDeserializer<IChatComponent>, JsonSerializer<IChatComponent>
    {
        ...
        public IChatComponent deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException
        {
            ...
            {
                return new 交流组分文本(p_deserialize_1_.getAsString());
            }
            ...
            else
            {
                ...
                {
                    ichatcomponent = new 交流组分文本(jsonobject.get("text").getAsString());
                }
                else if (jsonobject.has("translate"))
                {
                    ...
                    if (jsonobject.has("with"))
                    {
                        ...
                        for (int i = 0; i < aobject.length; ++i)
                        {
                            ...
                            if (aobject[i] instanceof 交流组分文本)
                            {
                                交流组分文本 chatcomponenttext = (交流组分文本)aobject[i];
        ...
        {
            if (p_serialize_1_ instanceof 交流组分文本 && p_serialize_1_.getChatStyle().isEmpty() && p_serialize_1_.getSiblings().isEmpty())
            {
                return new JsonPrimitive(((交流组分文本)p_serialize_1_).getChatComponentText_TextValue());
            }
            else
            {
                ...
                if (p_serialize_1_ instanceof 交流组分文本)
                {
                    jsonobject.addProperty("text", ((交流组分文本)p_serialize_1_).getChatComponentText_TextValue());
                }
