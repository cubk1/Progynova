...
public class ChatStyle
{
    ...
    private static final ChatStyle rootStyle = new ChatStyle()
    {
        ...
        public ChatStyle setColor(枚举聊天格式 color)
        {
    ...
    public String getFormattingCode()
    {
        ...
        else
        {
            ...
            if (this.getBold())
            {
                stringbuilder.append((Object) 枚举聊天格式.BOLD);
            }

            if (this.getItalic())
            {
                stringbuilder.append((Object) 枚举聊天格式.ITALIC);
            }

            if (this.getUnderlined())
            {
                stringbuilder.append((Object) 枚举聊天格式.UNDERLINE);
            }

            if (this.getObfuscated())
            {
                stringbuilder.append((Object) 枚举聊天格式.OBFUSCATED);
            }

            if (this.getStrikethrough())
            {
                stringbuilder.append((Object) 枚举聊天格式.STRIKETHROUGH);
            }
        ...
        public ChatStyle deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException
        {
            if (p_deserialize_1_.isJsonObject())
            {
                ...
                else
                {
                    ...
                    {
                        chatstyle.color = (枚举聊天格式)p_deserialize_3_.deserialize(jsonobject.get("color"), 枚举聊天格式.class);
                    }
