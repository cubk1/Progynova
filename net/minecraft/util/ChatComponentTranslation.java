...
public class ChatComponentTranslation extends ChatComponentStyle
{
    ...
    protected void initializeFromFormat(String format)
    {
        ...
        try
        {
            ...
            for (; matcher.find(j); j = l)
            {
                ...
                if (k > j)
                {
                    交流组分文本 chatcomponenttext = new 交流组分文本(String.format(format.substring(j, k), new Object[0]));
                ...
                {
                    交流组分文本 chatcomponenttext2 = new 交流组分文本("%");
            ...
            if (j < format.length())
            {
                交流组分文本 chatcomponenttext1 = new 交流组分文本(String.format(format.substring(j), new Object[0]));
    ...
    private IChatComponent getFormatArgumentAsComponent(int index)
    {
        ...
        else
        {
            ...
            {
                ichatcomponent = new 交流组分文本(object == null ? "null" : object.toString());
