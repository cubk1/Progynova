            ...
            if (this.interactionDelay == 0)
            {
                ...
                for (int i = 0; i < inventorybasic.getSizeInventory(); ++i)
                {
                    ...
                    if (itemstack1 != null)
                    {
                        ...
                        entityitem.通便X = (double)(-MathHelper.sin(f1 / 180.0F * (float)Math.PI) * MathHelper.cos(f2 / 180.0F * (float)Math.PI) * f);
                        entityitem.通便Z = (double)(MathHelper.cos(f1 / 180.0F * (float)Math.PI) * MathHelper.cos(f2 / 180.0F * (float)Math.PI) * f);
