...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    public void onUpdate()
    {
        ...
        if (entity != this)
        {
            ...
            {
                this.setPositionAndRotation(entity.posX, entity.posY, entity.posZ, entity.旋转侧滑, entity.rotationPitch);
    ...
    public EntityPlayer.EnumStatus trySleep(BlockPos bedLocation)
    {
        ...
        if (entityplayer$enumstatus == EntityPlayer.EnumStatus.OK)
        {
            ...
            this.playerNetServerHandler.setPlayerLocation(this.posX, this.posY, this.posZ, this.旋转侧滑, this.rotationPitch);
            this.playerNetServerHandler.sendPacket(packet);
        }
