...
public class EntityFishHook extends Entity
{
    ...
    public EntityFishHook(World worldIn, EntityPlayer fishingPlayer)
    {
        ...
        this.setSize(0.25F, 0.25F);
        this.setLocationAndAngles(fishingPlayer.posX, fishingPlayer.posY + (double)fishingPlayer.getEyeHeight(), fishingPlayer.posZ, fishingPlayer.旋转侧滑, fishingPlayer.rotationPitch);
