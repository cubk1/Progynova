...
public class 实体Painting extends 实体Hanging
{
    public 实体Painting.EnumArt art;

    public 实体Painting(World worldIn)
    {
        super(worldIn);
    }

    public 实体Painting(World worldIn, 阻止位置 pos, EnumFacing facing)
    {
        super(worldIn, pos);
        List<实体Painting.EnumArt> list = Lists.<实体Painting.EnumArt>newArrayList();

        for (实体Painting.EnumArt entitypainting$enumart : 实体Painting.EnumArt.values())
        {
        ...
        if (!list.isEmpty())
        {
            this.art = (实体Painting.EnumArt)list.get(this.rand.nextInt(list.size()));
        }

        this.updateFacingWithBoundingBox(facing);
    }

    public 实体Painting(World worldIn, 阻止位置 pos, EnumFacing facing, String title)
    {
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        if (this.art == null)
        {
            this.art = 实体Painting.EnumArt.KEBAB;
        }
    ...
    public void onBroken(实体 broken实体)
    {
        ...
        {
            if (broken实体 instanceof 实体Player)
            {
                实体Player entityplayer = (实体Player) broken实体;
    ...
    {
        阻止位置 blockpos = this.hangingPosition.add(x - this.X坐标, y - this.Y坐标, z - this.Z坐标);
