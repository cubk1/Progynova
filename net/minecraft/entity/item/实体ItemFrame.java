...
public class 实体ItemFrame extends 实体Hanging
{
    private float itemDropChance = 1.0F;

    public 实体ItemFrame(World worldIn)
    {
        super(worldIn);
    }

    public 实体ItemFrame(World worldIn, 阻止位置 p_i45852_2_, EnumFacing p_i45852_3_)
    {
    ...
    {
        this.dropItemOrSelf(broken实体, true);
    }

    public void dropItemOrSelf(实体 p_146065_1_, boolean p_146065_2_)
    {
        if (this.worldObj.getGameRules().getBoolean("doEntityDrops"))
        {
            ItemStack itemstack = this.getDisplayedItem();

            if (p_146065_1_ instanceof 实体Player)
            {
                实体Player entityplayer = (实体Player)p_146065_1_;
    ...
    private void removeFrameFromMap(ItemStack p_110131_1_)
    {
        if (p_110131_1_ != null)
        {
            ...
            p_110131_1_.setItemFrame((实体ItemFrame)null);
        }
    }
