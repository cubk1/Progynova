...
public abstract class 实体MinecartContainer extends 实体Minecart implements ILockableContainer
{
    private ItemStack[] minecartContainerItems = new ItemStack[36];
    private boolean dropContentsWhenDead = true;

    public 实体MinecartContainer(World worldIn)
    {
        super(worldIn);
    }

    public 实体MinecartContainer(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
