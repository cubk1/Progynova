...
public class EntityBoat extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if (d9 > 0.2975D)
        {
            ...
            for (int k = 0; (double)k < 1.0D + d9 * 60.0D; ++k)
            {
                ...
                if (this.rand.nextBoolean())
                {
                    ...
                    this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, d7, this.posY - 0.125D, d8, this.通便X, this.motionY, this.通便Z, new int[0]);
                }
                else
                {
                    double d24 = this.posX + d2 + d4 * d5 * 0.7D;
                    double d25 = this.posZ + d4 - d2 * d5 * 0.7D;
                    this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, d24, this.posY - 0.125D, d25, this.通便X, this.motionY, this.通便Z, new int[0]);
                }
            }
        }
        ...
        if (this.worldObj.isRemote && this.isBoatEmpty)
        {
            ...
            {
                double d13 = this.posX + this.通便X;
                double d17 = this.posY + this.motionY;
                double d20 = this.posZ + this.通便Z;
        ...
        else
        {
            ...
            if (this.riddenByEntity instanceof EntityLivingBase)
            {
                ...
                float f = this.riddenByEntity.旋转侧滑 + -entitylivingbase.moveStrafing * 90.0F;
