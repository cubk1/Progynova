...
public class 实体Wolf extends 实体Tameable
{
    ...
    public 实体Wolf(World worldIn)
    {
        ...
        this.tasks.addTask(9, new EntityAIWatchClosest(this, 实体Player.class, 8.0F));
        this.tasks.addTask(9, new EntityAILookIdle(this));
        this.targetTasks.addTask(1, new EntityAIOwnerHurtByTarget(this));
        this.targetTasks.addTask(2, new EntityAIOwnerHurtTarget(this));
        this.targetTasks.addTask(3, new EntityAIHurtByTarget(this, true, new Class[0]));
        this.targetTasks.addTask(4, new EntityAITargetNonTamed(this, 实体Animal.class, false, new Predicate<实体>()
        {
            public boolean apply(实体 p_apply_1_)
            {
                return p_apply_1_ instanceof 实体Sheep || p_apply_1_ instanceof 实体Rabbit;
            }
        }));
        this.targetTasks.addTask(5, new EntityAINearestAttackableTarget(this, 实体Skeleton.class, false));
        this.setTamed(false);
    }
        ...
        else if ((this.isWet || this.isShaking) && this.isShaking)
        {
            ...
            if (this.timeWolfIsShaking > 0.4F)
            {
                ...
                for (int j = 0; j < i; ++j)
                {
                    ...
                    this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, this.X坐标 + (double)f1, (double)(f + 0.8F), this.Z坐标 + (double)f2, this.通便X, this.motionY, this.通便Z, new int[0]);
                }
            }
        }
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        ...
        else
        {
            ...
            if (实体 != null && !(实体 instanceof 实体Player) && !(实体 instanceof 实体Arrow))
            {
    ...
    {
        boolean flag = 实体In.attackEntityFrom(DamageSource.causeMobDamage(this), (float)((int)this.getEntityAttribute(SharedMonsterAttributes.attackDamage).getAttributeValue()));
    ...
    public 实体Wolf createChild(实体Ageable ageable)
    {
        实体Wolf entitywolf = new 实体Wolf(this.worldObj);
    ...
    public boolean canMateWith(实体Animal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof 实体Wolf))
        {
            return false;
        }
        else
        {
            实体Wolf entitywolf = (实体Wolf)otherAnimal;
    ...
    {
        if (!(p_142018_1_ instanceof 实体Creeper) && !(p_142018_1_ instanceof 实体Ghast))
        {
            if (p_142018_1_ instanceof 实体Wolf)
            {
                实体Wolf entitywolf = (实体Wolf)p_142018_1_;
            ...
            return p_142018_1_ instanceof 实体Player && p_142018_2_ instanceof 实体Player && !((实体Player)p_142018_2_).canAttackPlayer((实体Player)p_142018_1_) ? false : !(p_142018_1_ instanceof 实体Horse) || !((实体Horse)p_142018_1_).isTame();
        }
        else
        {
            return false;
