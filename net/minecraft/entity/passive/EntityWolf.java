        ...
        else if ((this.isWet || this.isShaking) && this.isShaking)
        {
            ...
            if (this.timeWolfIsShaking > 0.4F)
            {
                ...
                for (int j = 0; j < i; ++j)
                {
                    ...
                    this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, this.posX + (double)f1, (double)(f + 0.8F), this.posZ + (double)f2, this.通便X, this.motionY, this.通便Z, new int[0]);
                }
            }
        }
    }
