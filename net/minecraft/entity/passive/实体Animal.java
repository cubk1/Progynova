...
public abstract class 实体Animal extends 实体Ageable implements IAnimals
{
    protected Block spawnableBlock = Blocks.grass;
    private int inLove;
    private 实体Player playerInLove;

    public 实体Animal(World worldIn)
    {
        super(worldIn);
    }
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.inLove > 0)
        {
            ...
            if (this.inLove % 10 == 0)
            {
                ...
                this.worldObj.spawnParticle(EnumParticleTypes.HEART, this.X坐标 + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.Y坐标 + 0.5D + (double)(this.rand.nextFloat() * this.height), this.Z坐标 + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, d0, d1, d2, new int[0]);
            }
        }
    }
    ...
    protected void consumeItemFromStack(实体Player player, ItemStack stack)
    {
    ...
    public void setInLove(实体Player player)
    {
        this.inLove = 600;
    ...
    public 实体Player getPlayerInLove()
    {
