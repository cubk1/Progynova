                ...
                if (!this.canBreatheUnderwater() && !this.isPotionActive(Potion.waterBreathing.id) && !flag1)
                {
                    ...
                    if (this.getAir() == -20)
                    {
                        ...
                        for (int i = 0; i < 8; ++i)
                        {
                            ...
                            this.worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX + (double)f, this.posY + (double)f1, this.posZ + (double)f2, this.通便X, this.motionY, this.通便Z, new int[0]);
                        }
    ...
    public void moveEntityWithHeading(float strafe, float forward)
    {
        if (this.isServerWorld())
        {
            if (!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)
            {
                if (!this.isInLava() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)
                {
                    ...
                    if (this.isOnLadder())
                    {
                        ...
                        boolean flag = this.正在下蹲() && this instanceof EntityPlayer;
                ...
                else
                {
                    ...
                    if (this.isCollidedHorizontally && this.isOffsetPositionInLiquid(this.通便X, this.motionY + 0.6000000238418579D - this.posY + d1, this.通便Z))
                    {
            ...
            else
            {
                ...
                if (this.isCollidedHorizontally && this.isOffsetPositionInLiquid(this.通便X, this.motionY + 0.6000000238418579D - this.posY + d0, this.通便Z))
                {
                    this.motionY = 0.30000001192092896D;
                }
            }
