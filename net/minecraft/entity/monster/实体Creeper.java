...
public class 实体Creeper extends 实体Mob
{
    ...
    public 实体Creeper(World worldIn)
    {
        super(worldIn);
        this.tasks.addTask(1, new EntityAISwimming(this));
        this.tasks.addTask(2, new EntityAICreeperSwell(this));
        this.tasks.addTask(3, new EntityAIAvoidEntity(this, 实体Ocelot.class, 6.0F, 1.0D, 1.2D));
        this.tasks.addTask(4, new EntityAIAttackOnCollide(this, 1.0D, false));
        this.tasks.addTask(5, new EntityAIWander(this, 0.8D));
        this.tasks.addTask(6, new EntityAIWatchClosest(this, 实体Player.class, 8.0F));
        this.tasks.addTask(6, new EntityAILookIdle(this));
        this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, 实体Player.class, true));
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if (cause.getEntity() instanceof 实体Skeleton)
        {
        ...
        else if (cause.getEntity() instanceof 实体Creeper && cause.getEntity() != this && ((实体Creeper)cause.getEntity()).getPowered() && ((实体Creeper)cause.getEntity()).isAIEnabled())
        {
    ...
    protected boolean interact(实体Player player)
    {
        ...
        {
            this.worldObj.playSoundEffect(this.X坐标 + 0.5D, this.Y坐标 + 0.5D, this.Z坐标 + 0.5D, "fire.ignite", 1.0F, this.rand.nextFloat() * 0.4F + 0.8F);
            player.swingItem();
    ...
    private void explode()
    {
        if (!this.worldObj.isRemote)
        {
            ...
            this.worldObj.createExplosion(this, this.X坐标, this.Y坐标, this.Z坐标, (float)this.explosionRadius * f, flag);
            this.setDead();
        }
    }
