    ...
    {
        {
            ...
            this.registerPacket(EnumPacketDirection.SERVERBOUND, 客户端数据包3玩家.class);
            this.registerPacket(EnumPacketDirection.SERVERBOUND, 客户端数据包3玩家.C04PacketPlayerPosition.class);
            this.registerPacket(EnumPacketDirection.SERVERBOUND, 客户端数据包3玩家.C05PacketPlayerLook.class);
            this.registerPacket(EnumPacketDirection.SERVERBOUND, 客户端数据包3玩家.C06PacketPlayerPosLook.class);
