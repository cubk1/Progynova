...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable
{
    ...
    {
        final 交流组分文本 chatcomponenttext = new 交流组分文本(reason);
        ...
        else
        {
            ...
            if (!this.playerEntity.playerConqueredTheEnd)
            {
                ...
                if (this.hasMoved)
                {
                    ...
                    {
                        this.playerEntity.onUpdateEntity();
                        this.playerEntity.setPositionAndRotation(this.lastPosX, this.lastPosY, this.lastPosZ, this.playerEntity.旋转侧滑, this.playerEntity.rotationPitch);
                        worldserver.updateEntity(this.playerEntity);
                        return;
                    }
                    ...
                    if (d15 - d14 > 100.0D && (!this.serverController.isSinglePlayer() || !this.serverController.getServerOwner().equals(this.playerEntity.getName())))
                    {
                        ...
                        this.setPlayerLocation(this.lastPosX, this.lastPosY, this.lastPosZ, this.playerEntity.旋转侧滑, this.playerEntity.rotationPitch);
                        return;
                    }
    ...
    public void processEntityAction(C0BPacketEntityAction packetIn)
    {
        ...
        switch (packetIn.getAction())
        {
            ...
            case START_SPRINTING:
                this.playerEntity.设置宇轩的疾跑状态(true);
                break;

            case STOP_SPRINTING:
                this.playerEntity.设置宇轩的疾跑状态(false);
                break;
    ...
    public void processUpdateSign(C12PacketUpdateSign packetIn)
    {
        ...
        if (worldserver.isBlockLoaded(blockpos))
        {
            ...
            {
                tileentitysign.signText[i] = new 交流组分文本(EnumChatFormatting.getTextWithoutFormattingCodes(aichatcomponent[i].getUnformattedText()));
            }
    ...
    public void processVanilla250Packet(C17PacketCustomPayload packetIn)
    {
        ...
        else if ("MC|AdvCdm".equals(packetIn.getChannelName()))
        {
            ...
            {
                this.playerEntity.增添聊天讯息(new ChatComponentTranslation("advMode.notEnabled"));
            }
            else if (this.playerEntity.canCommandSenderUseCommand(2, "") && this.playerEntity.capabilities.isCreativeMode)
            {
                ...
                try
                {
                    ...
                    if (commandblocklogic != null)
                    {
                        ...
                        this.playerEntity.增添聊天讯息(new ChatComponentTranslation("advMode.setCommand.success", s1));
                    }
                }
            ...
            {
                this.playerEntity.增添聊天讯息(new ChatComponentTranslation("advMode.notAllowed"));
            }
        }
