...
public class 客户端数据包3玩家 implements Packet<INetHandlerPlayServer>
{
    protected double x;
    protected double y;
    protected double z;
    ...
    public 客户端数据包3玩家(boolean isOnGround)
    {
    ...
    public static class C04PacketPlayerPosition extends 客户端数据包3玩家
    {
    ...
    public static class C05PacketPlayerLook extends 客户端数据包3玩家
    {
    ...
    public static class C06PacketPlayerPosLook extends 客户端数据包3玩家
    {
