...
public abstract class BlockContainer extends Block implements ITileEntityProvider
{
    ...
    protected boolean isInvalidNeighbor(World p_181086_1_, 阻止位置 p_181086_2_, EnumFacing p_181086_3_)
    {
        return p_181086_1_.getBlockState(p_181086_2_.offset(p_181086_3_)).getBlock().getMaterial() == Material.cactus;
    }

    protected boolean hasInvalidNeighbor(World p_181087_1_, 阻止位置 p_181087_2_)
    {
