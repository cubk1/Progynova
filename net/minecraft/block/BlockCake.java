...
public class BlockCake extends Block
{
    ...
    private void eatCake(World worldIn, 阻止位置 pos, IBlockState state, 实体Player player)
    {
        if (player.canEat(false))
        {
            player.triggerAchievement(StatList.field_181724_H);
            player.获取饥饿值().addStats(2, 0.1F);
    ...
    private boolean canBlockStay(World worldIn, 阻止位置 pos)
    {
