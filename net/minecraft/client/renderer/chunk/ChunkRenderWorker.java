    ...
    public void run()
    {
        while (true)
        {
            ...
            catch (Throwable throwable)
            {
                ...
                我的手艺.得到我的手艺().crashed(我的手艺.得到我的手艺().addGraphicsAndWorldToCrashReport(crashreport));
                return;
            }
        }
    }
        ...
        else
        {
            ...
            Futures.addCallback(listenablefuture, new FutureCallback<List<Object>>()
            {
                ...
                public void onFailure(Throwable p_onFailure_1_)
                {
                    ...
                    {
                        我的手艺.得到我的手艺().crashed(CrashReport.makeCrashReport(p_onFailure_1_, "Rendering chunk"));
                    }
                }
            });
        }
