...
public class OpenGlHelper
{
    ...
    {
        return Config.isMultiTexture() ? false : (Config.isRenderRegions() && !vboRegions ? false : vboSupported && 我的手艺.得到我的手艺().游戏一窝.useVbo);
    }
    ...
    {
        return Config.isFastRender() ? false : (Config.isAntialiasing() ? false : framebufferSupported && 我的手艺.得到我的手艺().游戏一窝.fboEnable);
    }
