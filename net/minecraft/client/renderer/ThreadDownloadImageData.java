...
public class ThreadDownloadImageData extends SimpleTexture
{
        ...
        this.imageThread = new Thread("Texture Downloader #" + threadDownloadCounter.incrementAndGet())
        {
            public void run()
            {
                ...
                else
                {
                    try
                    {
                        httpurlconnection = (HttpURLConnection)(new URL(ThreadDownloadImageData.this.imageUrl)).openConnection(我的手艺.得到我的手艺().getProxy());
    ...
    private boolean shouldPipeline()
    {
        ...
        {
            Proxy proxy = 我的手艺.得到我的手艺().getProxy();
    ...
    private void loadPipelined()
    {
        try
        {
            HttpRequest httprequest = HttpPipeline.makeRequest(this.imageUrl, 我的手艺.得到我的手艺().getProxy());
