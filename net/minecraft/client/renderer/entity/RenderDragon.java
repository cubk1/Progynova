...
public class RenderDragon extends RenderLiving<实体Dragon>
{
    ...
    protected void rotateCorpse(实体Dragon bat, float p_77043_2_, float p_77043_3_, float partialTicks)
    {
        ...
        光照状态经理.辐射(f1 * 10.0F, 1.0F, 0.0F, 0.0F);
        ...
        if (bat.deathTime > 0)
        {
            ...
            光照状态经理.辐射(f2 * this.getDeathMaxRotation(bat), 0.0F, 0.0F, 1.0F);
        }
    }
    ...
    protected void drawRechargeRay(实体Dragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_)
    {
        ...
        光照状态经理.推黑客帝国();
        光照状态经理.理解((float)p_180574_2_, (float)p_180574_4_ + 2.0F, (float)p_180574_6_);
        光照状态经理.辐射((float)(-Math.atan2((double)f4, (double)f2)) * 180.0F / (float)Math.PI - 90.0F, 0.0F, 1.0F, 0.0F);
        光照状态经理.辐射((float)(-Math.atan2((double)f5, (double)f3)) * 180.0F / (float)Math.PI - 90.0F, 1.0F, 0.0F, 0.0F);
