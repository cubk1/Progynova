...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!entity.isUser() || this.renderManager.livingPlayer == entity)
        {
            ...
            if (entity.正在下蹲() && !(entity instanceof EntityPlayerSP))
            {
                d0 = y - 0.125D;
            }
    ...
    private void setModelVisibilities(AbstractClientPlayer clientPlayer)
    {
        ...
        else
        {
            ...
            modelplayer.isSneak = clientPlayer.正在下蹲();
    ...
    protected void rotateCorpse(AbstractClientPlayer bat, float p_77043_2_, float p_77043_3_, float partialTicks)
    {
        ...
        {
            光照状态经理.辐射(bat.getBedOrientationInDegrees(), 0.0F, 1.0F, 0.0F);
            光照状态经理.辐射(this.getDeathMaxRotation(bat), 0.0F, 0.0F, 1.0F);
            光照状态经理.辐射(270.0F, 0.0F, 1.0F, 0.0F);
        }
        else
        {
