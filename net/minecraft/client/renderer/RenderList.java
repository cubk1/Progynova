...
public class RenderList extends ChunkRenderContainer
{
    ...
    private void drawRegion(int p_drawRegion_1_, int p_drawRegion_2_, IntBuffer p_drawRegion_3_)
    {
        ...
        光照状态经理.callLists(p_drawRegion_3_);
    ...
    {
        光照状态经理.理解((float)((double)p_preRenderRegion_1_ - this.viewEntityX), (float)((double)p_preRenderRegion_2_ - this.viewEntityY), (float)((double)p_preRenderRegion_3_ - this.viewEntityZ));
    }
}
