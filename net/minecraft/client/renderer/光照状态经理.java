...
public class 光照状态经理
{
    private static 光照状态经理.AlphaState alphaState = new 光照状态经理.AlphaState();
    private static 光照状态经理.BooleanState lightingState = new 光照状态经理.BooleanState(2896);
    private static 光照状态经理.BooleanState[] lightState = new 光照状态经理.BooleanState[8];
    private static 光照状态经理.ColorMaterialState colorMaterialState = new 光照状态经理.ColorMaterialState();
    private static 光照状态经理.BlendState blendState = new 光照状态经理.BlendState();
    private static 光照状态经理.DepthState depthState = new 光照状态经理.DepthState();
    private static 光照状态经理.FogState fogState = new 光照状态经理.FogState();
    private static 光照状态经理.CullState cullState = new 光照状态经理.CullState();
    private static 光照状态经理.PolygonOffsetState polygonOffsetState = new 光照状态经理.PolygonOffsetState();
    private static 光照状态经理.ColorLogicState colorLogicState = new 光照状态经理.ColorLogicState();
    private static 光照状态经理.TexGenState texGenState = new 光照状态经理.TexGenState();
    private static 光照状态经理.ClearState clearState = new 光照状态经理.ClearState();
    private static 光照状态经理.StencilState stencilState = new 光照状态经理.StencilState();
    private static 光照状态经理.BooleanState normalizeState = new 光照状态经理.BooleanState(2977);
    private static int activeTextureUnit = 0;
    private static 光照状态经理.TextureState[] textureState = new 光照状态经理.TextureState[32];
    private static int activeShadeModel = 7425;
    private static 光照状态经理.BooleanState rescaleNormalState = new 光照状态经理.BooleanState(32826);
    private static 光照状态经理.ColorMask colorMaskState = new 光照状态经理.ColorMask();
    private static 光照状态经理.Color colorState = new 光照状态经理.Color();
    ...
    public static void 禁用希腊字母表的第1个字母()
    {
    ...
    public static void 启用希腊字母表的第1个字母()
    {
        if (alphaLock.isLocked())
        {
    ...
    public static void 禁用纵深()
    {
        depthState.depthTest.setDisabled();
    }

    public static void 启用纵深()
    {
    ...
    public static void 正常工作(int srcFactor, int dstFactor)
    {
        if (blendLock.isLocked())
        {
    ...
    public static void enableTexGenCoord(光照状态经理.TexGen p_179087_0_)
    {
        texGenCoord(p_179087_0_).textureGen.setEnabled();
    }

    public static void disableTexGenCoord(光照状态经理.TexGen p_179100_0_)
    {
        texGenCoord(p_179100_0_).textureGen.setDisabled();
    }

    public static void texGen(光照状态经理.TexGen texGen, int param)
    {
        光照状态经理.TexGenCoord glstatemanager$texgencoord = texGenCoord(texGen);
    ...
    public static void texGen(光照状态经理.TexGen p_179105_0_, int pname, FloatBuffer params)
    {
        GL11.glTexGen(texGenCoord(p_179105_0_).coord, pname, params);
    }

    private static 光照状态经理.TexGenCoord texGenCoord(光照状态经理.TexGen p_179125_0_)
    {
        switch (p_179125_0_)
        {
            case S:
    ...
    public static void deleteTexture(int texture)
    {
        if (texture != 0)
        {
            ...
            for (光照状态经理.TextureState glstatemanager$texturestate : textureState)
            {
    ...
    public static void 绑定手感(int texture)
    {
    ...
    public static void 推黑客帝国()
    {
        GL11.glPushMatrix();
    }

    public static void 流行音乐黑客帝国()
    {
        GL11.glPopMatrix();
    }
    ...
    public static void 辐射(float angle, float x, float y, float z)
    {
        GL11.glRotatef(angle, x, y, z);
    }

    public static void 障眼物(float x, float y, float z)
    {
        GL11.glScalef(x, y, z);
    }

    public static void 障眼物(double x, double y, double z)
    {
        GL11.glScaled(x, y, z);
    }

    public static void 理解(float x, float y, float z)
    {
        GL11.glTranslatef(x, y, z);
    }

    public static void 理解(double x, double y, double z)
    {
    ...
    public static void 色彩(float colorRed, float colorGreen, float colorBlue, float colorAlpha)
    {
    ...
    public static void 色彩(float colorRed, float colorGreen, float colorBlue)
    {
        色彩(colorRed, colorGreen, colorBlue, 1.0F);
    }

    public static void 重设色彩()
    {
    ...
    public static void 不想(int p_glBegin_0_)
    {
        GL11.glBegin(p_glBegin_0_);
    }

    public static void 破灭()
    {
        GL11.glEnd();
    }
    ...
    public static void setBlendState(GlBlendState p_setBlendState_0_)
    {
        ...
        else
        {
            ...
            {
                正常工作(p_setBlendState_0_.getSrcFactor(), p_setBlendState_0_.getDstFactor());
            }
            else
            {
    ...
    static
    {
        for (int i = 0; i < 8; ++i)
        {
            lightState[i] = new 光照状态经理.BooleanState(16384 + i);
        }

        for (int j = 0; j < textureState.length; ++j)
        {
            textureState[j] = new 光照状态经理.TextureState();
        }
    }

    static class AlphaState
    {
        public 光照状态经理.BooleanState alphaTest;
        public int func;
        public float ref;

        private AlphaState()
        {
            this.alphaTest = new 光照状态经理.BooleanState(3008);
            this.func = 519;
            this.ref = -1.0F;
        }
    }
    ...
    {
        public 光照状态经理.BooleanState blend;
        ...
        private BlendState()
        {
            this.blend = new 光照状态经理.BooleanState(3042);
            this.srcFactor = 1;
            this.dstFactor = 0;
    ...
    {
        public double depth;
        public 光照状态经理.Color color;
        public int field_179204_c;

        private ClearState()
        {
            this.depth = 1.0D;
            this.color = new 光照状态经理.Color(0.0F, 0.0F, 0.0F, 0.0F);
    ...
    {
        public 光照状态经理.BooleanState colorLogicOp;
        public int opcode;

        private ColorLogicState()
        {
            this.colorLogicOp = new 光照状态经理.BooleanState(3058);
            this.opcode = 5379;
        }
    }
    ...
    {
        public 光照状态经理.BooleanState colorMaterial;
        public int face;
        public int mode;

        private ColorMaterialState()
        {
            this.colorMaterial = new 光照状态经理.BooleanState(2903);
            this.face = 1032;
            this.mode = 5634;
        }
    }
    ...
    {
        public 光照状态经理.BooleanState cullFace;
        public int mode;

        private CullState()
        {
            this.cullFace = new 光照状态经理.BooleanState(2884);
            this.mode = 1029;
        }
    }
    ...
    {
        public 光照状态经理.BooleanState depthTest;
        public boolean maskEnabled;
        public int depthFunc;

        private DepthState()
        {
            this.depthTest = new 光照状态经理.BooleanState(2929);
    ...
    {
        public 光照状态经理.BooleanState fog;
        public int mode;
        ...
        private FogState()
        {
            this.fog = new 光照状态经理.BooleanState(2912);
            this.mode = 2048;
            this.density = 1.0F;
            this.start = 0.0F;
            this.end = 1.0F;
    ...
    {
        public 光照状态经理.BooleanState polygonOffsetFill;
        public 光照状态经理.BooleanState polygonOffsetLine;
        public float factor;
        public float units;

        private PolygonOffsetState()
        {
            this.polygonOffsetFill = new 光照状态经理.BooleanState(32823);
            this.polygonOffsetLine = new 光照状态经理.BooleanState(10754);
            this.factor = 0.0F;
            this.units = 0.0F;
        }
    }
    ...
    {
        public 光照状态经理.StencilFunc field_179078_a;
        ...
        {
            this.field_179078_a = new 光照状态经理.StencilFunc();
    ...
    {
        public 光照状态经理.BooleanState textureGen;
        public int coord;
        public int param = -1;
        ...
        public TexGenCoord(int p_i46254_1_, int p_i46254_2_)
        {
            ...
            this.textureGen = new 光照状态经理.BooleanState(p_i46254_2_);
        }
    }

    static class TexGenState
    {
        public 光照状态经理.TexGenCoord s;
        public 光照状态经理.TexGenCoord t;
        public 光照状态经理.TexGenCoord r;
        public 光照状态经理.TexGenCoord q;

        private TexGenState()
        {
            this.s = new 光照状态经理.TexGenCoord(8192, 3168);
            this.t = new 光照状态经理.TexGenCoord(8193, 3169);
            this.r = new 光照状态经理.TexGenCoord(8194, 3170);
            this.q = new 光照状态经理.TexGenCoord(8195, 3171);
        }
    }

    static class TextureState
    {
        public 光照状态经理.BooleanState texture2DState;
        public int textureName;

        private TextureState()
        {
            this.texture2DState = new 光照状态经理.BooleanState(3553);
            this.textureName = 0;
        }
    }
}
