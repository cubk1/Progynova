...
public class ItemCameraTransforms
{
    ...
    public void applyTransform(ItemCameraTransforms.TransformType type)
    {
        ...
        {
            光照状态经理.理解(itemtransformvec3f.translation.x + field_181690_b, itemtransformvec3f.translation.y + field_181691_c, itemtransformvec3f.translation.z + field_181692_d);
            光照状态经理.辐射(itemtransformvec3f.rotation.y + field_181694_f, 0.0F, 1.0F, 0.0F);
            光照状态经理.辐射(itemtransformvec3f.rotation.x + field_181693_e, 1.0F, 0.0F, 0.0F);
            光照状态经理.辐射(itemtransformvec3f.rotation.z + field_181695_g, 0.0F, 0.0F, 1.0F);
            光照状态经理.障眼物(itemtransformvec3f.scale.x + field_181696_h, itemtransformvec3f.scale.y + field_181697_i, itemtransformvec3f.scale.z + field_181698_j);
        }
    }
