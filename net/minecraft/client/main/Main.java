...
public class Main
{
    public static void main(String[] p_main_0_)
    {
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("Player" + 我的手艺.getSystemTime() % 1000L);
        ...
        Runtime.getRuntime().addShutdownHook(new Thread("Client Shutdown Thread")
        {
            public void run()
            {
                我的手艺.stopIntegratedServer();
            }
        });
        Thread.currentThread().setName("Client thread");
        (new 我的手艺(gameconfiguration)).run();
    }
