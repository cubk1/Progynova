...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    public NetHandlerLoginClient(NetworkManager networkManagerIn, 我的手艺 mcIn, 鬼Screen p_i45059_3_)
    {
    ...
    {
        this.mc.displayGuiScreen(new 鬼Disconnected(this.previousGuiScreen, "connect.failed", reason));
    }
