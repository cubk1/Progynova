...
import net.minecraft.client.gui.鬼ScreenWorking;
...
public class ResourcePackRepository
{
    ...
    public ListenableFuture<Object> downloadResourcePack(String url, String hash)
    {
        ...
        try
        {
            ...
            final 鬼ScreenWorking guiscreenworking = new 鬼ScreenWorking();
            Map<String, String> map = 我的手艺.getSessionInfo();
            final 我的手艺 宇轩的世界 = 我的手艺.得到我的手艺();
            Futures.getUnchecked(宇轩的世界.addScheduledTask(new Runnable()
            {
                public void run()
                {
                    宇轩的世界.displayGuiScreen(guiscreenworking);
                }
            }));
            final SettableFuture<Object> settablefuture = SettableFuture.<Object>create();
            this.downloadingPacks = HttpUtil.downloadResourcePack(file1, url, map, 52428800, guiscreenworking, 宇轩的世界.getProxy());
    ...
    public ListenableFuture<Object> setResourcePackInstance(File resourceFile)
    {
        ...
        return 我的手艺.得到我的手艺().scheduleResourcesRefresh();
    }
    ...
    public void clearResourcePack()
    {
        ...
        try
        {
            ...
            if (this.resourcePackInstance != null)
            {
                ...
                我的手艺.得到我的手艺().scheduleResourcesRefresh();
            }
        }
        finally
        {
    ...
    public class Entry
    {
        ...
        private 图像位置 locationTexturePackIcon;
        ...
        public void bindTexturePackIcon(TextureManager textureManagerIn)
        {
            ...
            textureManagerIn.绑定手感(this.locationTexturePackIcon);
        }
        ...
        {
            return this.rePackMetadataSection == null ? 枚举聊天格式.RED + "Invalid pack.mcmeta (or missing \'pack\' section)" : this.rePackMetadataSection.getPackDescription().getFormattedText();
        }
