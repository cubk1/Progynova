...
import net.optifine.gui.鬼PerformanceSettingsOF;
import net.optifine.shaders.gui.鬼Shaders;

public class 鬼VideoSettings extends 鬼ScreenOF
{
    private 鬼Screen parentGuiScreen;
    ...
    public 鬼VideoSettings(鬼Screen parentScreenIn, GameSettings gameSettingsIn)
    {
    ...
    public void initGui()
    {
        ...
        for (int i = 0; i < videoOptions.length; ++i)
        {
            ...
            if (gamesettings$options != null)
            {
                ...
                {
                    this.buttonList.add(new 鬼OptionButtonOF(gamesettings$options.returnEnumOrdinal(), j, k, gamesettings$options, this.guiGameSettings.getKeyBinding(gamesettings$options)));
                }
            }
        }
        ...
        this.buttonList.add(new 鬼OptionButton(231, i1, l, Lang.get("of.options.shaders")));
        i1 = this.width / 2 - 155 + 160;
        this.buttonList.add(new 鬼OptionButton(202, i1, l, Lang.get("of.options.quality")));
        l = l + 21;
        i1 = this.width / 2 - 155 + 0;
        this.buttonList.add(new 鬼OptionButton(201, i1, l, Lang.get("of.options.details")));
        i1 = this.width / 2 - 155 + 160;
        this.buttonList.add(new 鬼OptionButton(212, i1, l, Lang.get("of.options.performance")));
        l = l + 21;
        i1 = this.width / 2 - 155 + 0;
        this.buttonList.add(new 鬼OptionButton(211, i1, l, Lang.get("of.options.animations")));
        i1 = this.width / 2 - 155 + 160;
        this.buttonList.add(new 鬼OptionButton(222, i1, l, Lang.get("of.options.other")));
        l = l + 21;
    ...
    protected void actionPerformedRightClick(鬼Button p_actionPerformedRightClick_1_)
    {
    ...
    private void actionPerformed(鬼Button p_actionPerformed_1_, int p_actionPerformed_2_)
    {
        if (p_actionPerformed_1_.enabled)
        {
            int i = this.guiGameSettings.guiScale;

            if (p_actionPerformed_1_.id < 200 && p_actionPerformed_1_ instanceof 鬼OptionButton)
            {
                this.guiGameSettings.setOptionValue(((鬼OptionButton)p_actionPerformed_1_).returnEnumOptions(), p_actionPerformed_2_);
            ...
            {
                this.mc.游戏一窝.saveOptions();
                鬼DetailSettingsOF guidetailsettingsof = new 鬼DetailSettingsOF(this, this.guiGameSettings);
            ...
            {
                this.mc.游戏一窝.saveOptions();
                鬼QualitySettingsOF guiqualitysettingsof = new 鬼QualitySettingsOF(this, this.guiGameSettings);
            ...
            {
                this.mc.游戏一窝.saveOptions();
                鬼AnimationSettingsOF guianimationsettingsof = new 鬼AnimationSettingsOF(this, this.guiGameSettings);
            ...
            {
                this.mc.游戏一窝.saveOptions();
                鬼PerformanceSettingsOF guiperformancesettingsof = new 鬼PerformanceSettingsOF(this, this.guiGameSettings);
            ...
            {
                this.mc.游戏一窝.saveOptions();
                鬼OtherSettingsOF guiothersettingsof = new 鬼OtherSettingsOF(this, this.guiGameSettings);
            ...
            if (p_actionPerformed_1_.id == 231)
            {
                ...
                this.mc.游戏一窝.saveOptions();
                鬼Shaders guishaders = new 鬼Shaders(this, this.guiGameSettings);
    ...
    public static int getButtonWidth(鬼Button p_getButtonWidth_0_)
    {
        return p_getButtonWidth_0_.width;
    }

    public static int getButtonHeight(鬼Button p_getButtonHeight_0_)
    {
        return p_getButtonHeight_0_.height;
    }

    public static void drawGradientRect(鬼Screen p_drawGradientRect_0_, int p_drawGradientRect_1_, int p_drawGradientRect_2_, int p_drawGradientRect_3_, int p_drawGradientRect_4_, int p_drawGradientRect_5_, int p_drawGradientRect_6_)
    {
    ...
    public static String getGuiChatText(鬼Chat p_getGuiChatText_0_)
    {
