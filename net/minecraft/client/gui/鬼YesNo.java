...
public class 鬼YesNo extends 鬼Screen
{
    ...
    public 鬼YesNo(GuiYesNoCallback p_i1082_1_, String p_i1082_2_, String p_i1082_3_, int p_i1082_4_)
    {
    ...
    public 鬼YesNo(GuiYesNoCallback p_i1083_1_, String p_i1083_2_, String p_i1083_3_, String p_i1083_4_, String p_i1083_5_, int p_i1083_6_)
    {
    ...
    public void initGui()
    {
        this.buttonList.add(new 鬼OptionButton(0, this.width / 2 - 155, this.height / 6 + 96, this.confirmButtonText));
        this.buttonList.add(new 鬼OptionButton(1, this.width / 2 - 155 + 160, this.height / 6 + 96, this.cancelButtonText));
