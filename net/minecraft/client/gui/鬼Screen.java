...
import net.minecraft.client.gui.stream.鬼TwitchUserMode;
...
public abstract class 鬼Screen extends 鬼 implements GuiYesNoCallback
{
    ...
    public int width;
    public int height;
    protected List<鬼Button> buttonList = Lists.<鬼Button>newArrayList();
    protected List<鬼Label> labelList = Lists.<鬼Label>newArrayList();
    public boolean allowUserInput;
    protected FontRenderer fontRendererObj;
    private 鬼Button selectedButton;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            ((鬼Button)this.buttonList.get(i)).drawButton(this.mc, mouseX, mouseY);
        }

        for (int j = 0; j < this.labelList.size(); ++j)
        {
            ((鬼Label)this.labelList.get(j)).drawLabel(this.mc, mouseX, mouseY);
        }
    }
    ...
    protected void handleComponentHover(IChatComponent component, int x, int y)
    {
        if (component != null && component.getChatStyle().getChatHoverEvent() != null)
        {
            ...
            {
                if (this.mc.游戏一窝.advancedItemTooltips)
                {
                    try
                    {
            ...
            else if (clickevent != null)
            {
                if (clickevent.getAction() == ClickEvent.Action.OPEN_URL)
                {
                    ...
                    try
                    {
                        ...
                        if (this.mc.游戏一窝.chatLinksPrompt)
                        {
                            this.clickedLinkURI = uri;
                            this.mc.displayGuiScreen(new 鬼ConfirmOpenLink(this, clickevent.getValue(), 31102009, false));
                        }
                        else
                        {
                ...
                else if (clickevent.getAction() == ClickEvent.Action.TWITCH_USER_INFO)
                {
                    ...
                    {
                        this.mc.displayGuiScreen(new 鬼TwitchUserMode(this.mc.getTwitchStream(), chatuserinfo));
                    }
                    else
                    {
    ...
    public void sendChatMessage(String msg, boolean addToChat)
    {
        ...
        this.mc.宇轩游玩者.sendChatMessage(msg);
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
            for (int i = 0; i < this.buttonList.size(); ++i)
            {
                鬼Button guibutton = (鬼Button)this.buttonList.get(i);
    ...
    public void setWorldAndResolution(我的手艺 mc, int width, int height)
    {
        this.mc = mc;
    ...
    public void handleMouseInput() throws IOException
    {
        ...
        {
            if (this.mc.游戏一窝.touchscreen && this.touchValue++ > 0)
            {
                return;
            }

            this.eventButton = k;
            this.lastMouseEvent = 我的手艺.getSystemTime();
        ...
        {
            long l = 我的手艺.getSystemTime() - this.lastMouseEvent;
    ...
    {
        return 我的手艺.isRunningOnMac ? Keyboard.isKeyDown(219) || Keyboard.isKeyDown(220) : Keyboard.isKeyDown(29) || Keyboard.isKeyDown(157);
    }
    ...
    public void onResize(我的手艺 mcIn, int w, int h)
    {
