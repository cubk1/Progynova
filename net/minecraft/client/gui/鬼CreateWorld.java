...
public class 鬼CreateWorld extends 鬼Screen
{
    private 鬼Screen parentScreen;
    private 鬼TextField worldNameField;
    private 鬼TextField worldSeedField;
    ...
    private 鬼Button btnGameMode;
    private 鬼Button btnMoreOptions;
    private 鬼Button btnMapFeatures;
    private 鬼Button btnBonusItems;
    private 鬼Button btnMapType;
    private 鬼Button btnAllowCommands;
    private 鬼Button btnCustomizeType;
    ...
    public 鬼CreateWorld(鬼Screen p_i46320_1_)
    {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new 鬼Button(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("selectWorld.create", new Object[0])));
        this.buttonList.add(new 鬼Button(1, this.width / 2 + 5, this.height - 28, 150, 20, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(this.btnGameMode = new 鬼Button(2, this.width / 2 - 75, 115, 150, 20, I18n.format("selectWorld.gameMode", new Object[0])));
        this.buttonList.add(this.btnMoreOptions = new 鬼Button(3, this.width / 2 - 75, 187, 150, 20, I18n.format("selectWorld.moreWorldOptions", new Object[0])));
        this.buttonList.add(this.btnMapFeatures = new 鬼Button(4, this.width / 2 - 155, 100, 150, 20, I18n.format("selectWorld.mapFeatures", new Object[0])));
        this.btnMapFeatures.visible = false;
        this.buttonList.add(this.btnBonusItems = new 鬼Button(7, this.width / 2 + 5, 151, 150, 20, I18n.format("selectWorld.bonusItems", new Object[0])));
        this.btnBonusItems.visible = false;
        this.buttonList.add(this.btnMapType = new 鬼Button(5, this.width / 2 + 5, 100, 150, 20, I18n.format("selectWorld.mapType", new Object[0])));
        this.btnMapType.visible = false;
        this.buttonList.add(this.btnAllowCommands = new 鬼Button(6, this.width / 2 - 155, 151, 150, 20, I18n.format("selectWorld.allowCommands", new Object[0])));
        this.btnAllowCommands.visible = false;
        this.buttonList.add(this.btnCustomizeType = new 鬼Button(8, this.width / 2 + 5, 120, 150, 20, I18n.format("selectWorld.customizeType", new Object[0])));
        this.btnCustomizeType.visible = false;
        this.worldNameField = new 鬼TextField(9, this.fontRendererObj, this.width / 2 - 100, 60, 200, 20);
        this.worldNameField.setFocused(true);
        this.worldNameField.setText(this.worldName);
        this.worldSeedField = new 鬼TextField(10, this.fontRendererObj, this.width / 2 - 100, 60, 200, 20);
    ...
    protected void actionPerformed(鬼Button button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 8)
            {
                ...
                {
                    this.mc.displayGuiScreen(new 鬼CreateFlatWorld(this, this.chunkProviderSettingsJson));
                }
                else
                {
                    this.mc.displayGuiScreen(new 鬼CustomizeWorldScreen(this, this.chunkProviderSettingsJson));
                }
            }
        }
    }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        {
            this.actionPerformed((鬼Button)this.buttonList.get(0));
        }

        ((鬼Button)this.buttonList.get(0)).enabled = this.worldNameField.getText().length() > 0;
        this.calcSaveDirName();
    }
