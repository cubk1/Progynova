...
public class 鬼TextField extends 鬼
{
    ...
    public 鬼TextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public boolean textboxKeyTyped(char p_146201_1_, int p_146201_2_)
    {
        ...
        else if (鬼Screen.isKeyComboCtrlA(p_146201_2_))
        {
            this.setCursorPositionEnd();
            this.setSelectionPos(0);
            return true;
        }
        else if (鬼Screen.isKeyComboCtrlC(p_146201_2_))
        {
            鬼Screen.setClipboardString(this.getSelectedText());
            return true;
        }
        else if (鬼Screen.isKeyComboCtrlV(p_146201_2_))
        {
            if (this.isEnabled)
            {
                this.writeText(鬼Screen.getClipboardString());
            }

            return true;
        }
        else if (鬼Screen.isKeyComboCtrlX(p_146201_2_))
        {
            鬼Screen.setClipboardString(this.getSelectedText());
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                j1 = this.fontRendererInstance.绘制纵梁带心理阴影(s1, (float)l, (float)i1, i);
            }
            ...
            {
                j1 = this.fontRendererInstance.绘制纵梁带心理阴影(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                if (flag2)
                {
                    鬼.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
                }
                else
                {
                    this.fontRendererInstance.绘制纵梁带心理阴影("_", (float)k1, (float)i1, i);
                }
            }
    ...
    private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_)
    {
        ...
        光照状态经理.色彩(0.0F, 0.0F, 255.0F, 255.0F);
        光照状态经理.禁用手感();
        光照状态经理.enableColorLogic();
        光照状态经理.colorLogicOp(5387);
