...
public abstract class GuiSlot
{
    ...
    public GuiSlot(我的手艺 mcIn, int width, int height, int topIn, int bottomIn, int slotHeightIn)
    {
        this.mc = mcIn;
        this.width = width;
        this.height = height;
    ...
    public void actionPerformed(鬼Button button)
    {
        if (button.enabled)
        {
            ...
            if (Mouse.isButtonDown(0) && this.getEnabled())
            {
                ...
                else
                {
                    ...
                    if (this.mouseY >= this.top && this.mouseY <= this.bottom)
                    {
                        ...
                        {
                            boolean flag = i1 == this.selectedElement && 我的手艺.getSystemTime() - this.lastClicked < 250L;
                            this.elementClicked(i1, flag, this.mouseX, this.mouseY);
                            this.selectedElement = i1;
                            this.lastClicked = 我的手艺.getSystemTime();
                        }
