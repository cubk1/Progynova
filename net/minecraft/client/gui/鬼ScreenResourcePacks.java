...
public class 鬼ScreenResourcePacks extends 鬼Screen
{
    ...
    public 鬼ScreenResourcePacks(鬼Screen parentScreenIn)
    {
    ...
    public void initGui()
    {
        this.buttonList.add(new 鬼OptionButton(2, this.width / 2 - 154, this.height - 48, I18n.format("resourcePack.openFolder", new Object[0])));
        this.buttonList.add(new 鬼OptionButton(1, this.width / 2 + 4, this.height - 48, I18n.format("gui.done", new Object[0])));
        ...
        if (button.enabled)
        {
            ...
            else if (button.id == 1)
            {
                if (this.changed)
                {
                    ...
                    this.mc.游戏一窝.resourcePacks.clear();
                    this.mc.游戏一窝.incompatibleResourcePacks.clear();

                    for (ResourcePackRepository.Entry resourcepackrepository$entry : list)
                    {
                        this.mc.游戏一窝.resourcePacks.add(resourcepackrepository$entry.getResourcePackName());

                        if (resourcepackrepository$entry.func_183027_f() != 1)
                        {
                            this.mc.游戏一窝.incompatibleResourcePacks.add(resourcepackrepository$entry.getResourcePackName());
                        }
                    }
