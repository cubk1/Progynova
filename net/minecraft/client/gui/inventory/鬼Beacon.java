...
public class 鬼Beacon extends 鬼Container
{
    ...
    public 鬼Beacon(InventoryPlayer playerInventory, IInventory tileBeaconIn)
    {
    ...
    {
        super.initGui();
        this.buttonList.add(this.beaconConfirmButton = new 鬼Beacon.ConfirmButton(-1, this.guiLeft + 164, this.guiTop + 107));
        this.buttonList.add(new 鬼Beacon.CancelButton(-2, this.guiLeft + 190, this.guiTop + 107));
        ...
        if (this.buttonsNotDrawn && i >= 0)
        {
            ...
            for (int l = 0; l <= 2; ++l)
            {
                ...
                for (int k1 = 0; k1 < i1; ++k1)
                {
                    ...
                    鬼Beacon.PowerButton guibeacon$powerbutton = new 鬼Beacon.PowerButton(l << 8 | l1, this.guiLeft + 76 + k1 * 24 - j1 / 2, this.guiTop + 22 + l * 25, l1, l);
            ...
            for (int l2 = 0; l2 < j2 - 1; ++l2)
            {
                ...
                鬼Beacon.PowerButton guibeacon$powerbutton2 = new 鬼Beacon.PowerButton(i2 << 8 | i3, this.guiLeft + 167 + l2 * 24 - k2 / 2, this.guiTop + 47, i3, i2);
            ...
            if (j > 0)
            {
                鬼Beacon.PowerButton guibeacon$powerbutton1 = new 鬼Beacon.PowerButton(i2 << 8 | j, this.guiLeft + 167 + (j2 - 1) * 24 - k2 / 2, this.guiTop + 47, j, i2);
    ...
    protected void actionPerformed(鬼Button button) throws IOException
    {
        ...
        else if (button instanceof 鬼Beacon.PowerButton)
        {
            if (((鬼Beacon.PowerButton)button).func_146141_c())
            {
                return;
            }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.mc.得到手感经理().绑定手感(beaconGuiTextures);
    ...
    static class Button extends 鬼Button
    {
        ...
        public void drawButton(我的手艺 mc, int mouseX, int mouseY)
        {
            if (this.visible)
            {
                mc.得到手感经理().绑定手感(鬼Beacon.beaconGuiTextures);
                光照状态经理.色彩(1.0F, 1.0F, 1.0F, 1.0F);
                ...
                if (!鬼Beacon.beaconGuiTextures.equals(this.field_146145_o))
                {
                    mc.得到手感经理().绑定手感(this.field_146145_o);
                }
    ...
    class CancelButton extends 鬼Beacon.Button
    {
        public CancelButton(int p_i1074_2_, int p_i1074_3_, int p_i1074_4_)
        {
            super(p_i1074_2_, p_i1074_3_, p_i1074_4_, 鬼Beacon.beaconGuiTextures, 112, 220);
        }

        public void drawButtonForegroundLayer(int mouseX, int mouseY)
        {
            鬼Beacon.this.drawCreativeTabHoveringText(I18n.format("gui.cancel", new Object[0]), mouseX, mouseY);
        }
    }

    class ConfirmButton extends 鬼Beacon.Button
    {
        public ConfirmButton(int p_i1075_2_, int p_i1075_3_, int p_i1075_4_)
        {
            super(p_i1075_2_, p_i1075_3_, p_i1075_4_, 鬼Beacon.beaconGuiTextures, 90, 220);
        }

        public void drawButtonForegroundLayer(int mouseX, int mouseY)
        {
            鬼Beacon.this.drawCreativeTabHoveringText(I18n.format("gui.done", new Object[0]), mouseX, mouseY);
        }
    }

    class PowerButton extends 鬼Beacon.Button
    {
        ...
        {
            super(p_i1076_2_, p_i1076_3_, p_i1076_4_, 鬼Container.inventoryBackground, 0 + Potion.potionTypes[p_i1076_5_].getStatusIconIndex() % 8 * 18, 198 + Potion.potionTypes[p_i1076_5_].getStatusIconIndex() / 8 * 18);
        ...
        public void drawButtonForegroundLayer(int mouseX, int mouseY)
        {
            ...
            鬼Beacon.this.drawCreativeTabHoveringText(s, mouseX, mouseY);
        }
    }
}
