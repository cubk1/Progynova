...
public abstract class 鬼Container extends 鬼Screen
{
    ...
    public 鬼Container(Container inventorySlotsIn)
    {
    ...
    {
        super.initGui();
        this.mc.宇轩游玩者.openContainer = this.inventorySlots;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        光照状态经理.推黑客帝国();
        光照状态经理.理解((float)i, (float)j, 0.0F);
        ...
        {
            float f = (float)(我的手艺.getSystemTime() - this.returningStackTime) / 100.0F;
    ...
    private void drawSlot(Slot slotIn)
    {
        ...
        ItemStack itemstack1 = this.mc.宇轩游玩者.inventory.getItemStack();
        String s = null;
    ...
    {
        ItemStack itemstack = this.mc.宇轩游玩者.inventory.getItemStack();
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        boolean flag = mouseButton == this.mc.游戏一窝.keyBindPickBlock.getKeyCode() + 100;
        ...
        if (mouseButton == 0 || mouseButton == 1 || flag)
        {
            ...
            if (this.mc.游戏一窝.touchscreen && flag1 && this.mc.宇轩游玩者.inventory.getItemStack() == null)
            {
            ...
            if (l != -1)
            {
                ...
                {
                    if (this.mc.宇轩游玩者.inventory.getItemStack() == null)
                    {
                        if (mouseButton == this.mc.游戏一窝.keyBindPickBlock.getKeyCode() + 100)
                        {
                    ...
                    else
                    {
                        ...
                        else if (mouseButton == this.mc.游戏一窝.keyBindPickBlock.getKeyCode() + 100)
                        {
    ...
    protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick)
    {
        ...
        if (this.clickedSlot != null && this.mc.游戏一窝.touchscreen)
        {
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state)
    {
        ...
        if (this.doubleClick && slot != null && state == 0 && this.inventorySlots.canMergeSlot((ItemStack)null, slot))
        {
            if (isShiftKeyDown())
            {
                if (slot != null && slot.inventory != null && this.shiftClickedSlot != null)
                {
                    ...
                    {
                        if (slot2 != null && slot2.canTakeStack(this.mc.宇轩游玩者) && slot2.getHasStack() && slot2.inventory == slot.inventory && Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true))
                        {
        ...
        else
        {
                ...
                if (state == 0 || state == 1)
                {
                    ...
                    if (k != -1 && this.draggedStack != null && flag2)
                    {
                        ...
                        if (this.mc.宇轩游玩者.inventory.getItemStack() != null)
                        {
                            ...
                            this.returningStackTime = 我的手艺.getSystemTime();
                        }
                        else
                        {
                            this.returningStack = null;
            ...
            else if (this.mc.宇轩游玩者.inventory.getItemStack() != null)
            {
                if (state == this.mc.游戏一窝.keyBindPickBlock.getKeyCode() + 100)
                {
    ...
    {
        if (keyCode == 1 || keyCode == this.mc.游戏一窝.keyBindInventory.getKeyCode())
        {
            this.mc.宇轩游玩者.closeScreen();
        }
        ...
        {
            if (keyCode == this.mc.游戏一窝.keyBindPickBlock.getKeyCode())
            {
                this.handleMouseClick(this.theSlot, this.theSlot.slotNumber, 0, 3);
            }
            else if (keyCode == this.mc.游戏一窝.keyBindDrop.getKeyCode())
            {
    ...
    {
        if (this.mc.宇轩游玩者.inventory.getItemStack() == null && this.theSlot != null)
        {
            for (int i = 0; i < 9; ++i)
            {
                if (keyCode == this.mc.游戏一窝.keyBindsHotbar[i].getKeyCode())
                {
    ...
    public void onGuiClosed()
    {
        ...
        {
            this.inventorySlots.onContainerClosed(this.mc.宇轩游玩者);
        }
    }
    ...
    public void updateScreen()
    {
        ...
        if (!this.mc.宇轩游玩者.isEntityAlive() || this.mc.宇轩游玩者.isDead)
        {
            this.mc.宇轩游玩者.closeScreen();
        }
    }
