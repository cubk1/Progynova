...
import net.minecraft.client.gui.鬼TextField;
...
public class 鬼ContainerCreative extends InventoryEffectRenderer
{
    ...
    private 鬼TextField searchField;
    ...
    public void updateScreen()
    {
        ...
        {
            this.mc.displayGuiScreen(new 鬼Inventory(this.mc.宇轩游玩者));
        }
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType)
    {
        ...
        {
            InventoryPlayer inventoryplayer1 = this.mc.宇轩游玩者.inventory;

            if (inventoryplayer1.getItemStack() != null)
            {
                if (clickedButton == 0)
                {
                    this.mc.宇轩游玩者.dropPlayerItemWithRandomChoice(inventoryplayer1.getItemStack());
                    this.mc.玩家控制者.sendPacketDropItem(inventoryplayer1.getItemStack());
                ...
                if (clickedButton == 1)
                {
                    ...
                    this.mc.宇轩游玩者.dropPlayerItemWithRandomChoice(itemstack5);
                    this.mc.玩家控制者.sendPacketDropItem(itemstack5);
        ...
        {
            for (int j = 0; j < this.mc.宇轩游玩者.inventoryContainer.getInventory().size(); ++j)
            {
                this.mc.玩家控制者.sendSlotPacket((ItemStack)null, j);
            }
        }
        else if (selectedTabIndex == CreativeTabs.tabInventory.getTabIndex())
        {
            ...
            {
                this.mc.宇轩游玩者.inventory.setItemStack((ItemStack)null);
            }
            else if (clickType == 4 && slotIn != null && slotIn.getHasStack())
            {
                ...
                this.mc.宇轩游玩者.dropPlayerItemWithRandomChoice(itemstack);
                this.mc.玩家控制者.sendPacketDropItem(itemstack);
            }
            else if (clickType == 4 && this.mc.宇轩游玩者.inventory.getItemStack() != null)
            {
                this.mc.宇轩游玩者.dropPlayerItemWithRandomChoice(this.mc.宇轩游玩者.inventory.getItemStack());
                this.mc.玩家控制者.sendPacketDropItem(this.mc.宇轩游玩者.inventory.getItemStack());
                this.mc.宇轩游玩者.inventory.setItemStack((ItemStack)null);
            }
            else
            {
                this.mc.宇轩游玩者.inventoryContainer.slotClick(slotIn == null ? slotId : ((鬼ContainerCreative.CreativeSlot)slotIn).slot.slotNumber, clickedButton, clickType, this.mc.宇轩游玩者);
                this.mc.宇轩游玩者.inventoryContainer.detectAndSendChanges();
            }
        }
        else if (clickType != 5 && slotIn.inventory == field_147060_v)
        {
            InventoryPlayer inventoryplayer = this.mc.宇轩游玩者.inventory;
            ...
            if (clickType == 2)
            {
                if (itemstack2 != null && clickedButton >= 0 && clickedButton < 9)
                {
                    ...
                    this.mc.宇轩游玩者.inventory.setInventorySlotContents(clickedButton, itemstack7);
                    this.mc.宇轩游玩者.inventoryContainer.detectAndSendChanges();
                }
            ...
            if (clickType == 4)
            {
                if (itemstack2 != null)
                {
                    ...
                    this.mc.宇轩游玩者.dropPlayerItemWithRandomChoice(itemstack3);
                    this.mc.玩家控制者.sendPacketDropItem(itemstack3);
                }
        ...
        {
            this.inventorySlots.slotClick(slotIn == null ? slotId : slotIn.slotNumber, clickedButton, clickType, this.mc.宇轩游玩者);

            if (Container.getDragEvent(clickedButton) == 2)
            {
                for (int i = 0; i < 9; ++i)
                {
                    this.mc.玩家控制者.sendSlotPacket(this.inventorySlots.getSlot(45 + i).getStack(), 36 + i);
                }
            }
            else if (slotIn != null)
            {
                ItemStack itemstack4 = this.inventorySlots.getSlot(slotIn.slotNumber).getStack();
                this.mc.玩家控制者.sendSlotPacket(itemstack4, slotIn.slotNumber - this.inventorySlots.inventorySlots.size() + 9 + 36);
            }
        }
    }
    ...
    public void initGui()
    {
        if (this.mc.玩家控制者.是创造模式吗())
        {
            ...
            this.searchField = new 鬼TextField(0, this.fontRendererObj, this.guiLeft + 82, this.guiTop + 6, 89, this.fontRendererObj.FONT_HEIGHT);
            ...
            this.mc.宇轩游玩者.inventoryContainer.onCraftGuiOpened(this.field_147059_E);
        }
        else
        {
            this.mc.displayGuiScreen(new 鬼Inventory(this.mc.宇轩游玩者));
    ...
    public void onGuiClosed()
    {
        ...
        if (this.mc.宇轩游玩者 != null && this.mc.宇轩游玩者.inventory != null)
        {
            this.mc.宇轩游玩者.inventoryContainer.removeCraftingFromCrafters(this.field_147059_E);
        }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        {
            if (GameSettings.isKeyDown(this.mc.游戏一窝.keyBindChat))
            {
    ...
    {
        鬼ContainerCreative.ContainerCreative guicontainercreative$containercreative = (鬼ContainerCreative.ContainerCreative)this.inventorySlots;
    ...
    {
        return selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && CreativeTabs.creativeTabArray[selectedTabIndex].shouldHidePlayerInventory() && ((鬼ContainerCreative.ContainerCreative)this.inventorySlots).func_148328_e();
    }
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_)
    {
        ...
        {
            Container container = this.mc.宇轩游玩者.inventoryContainer;
            ...
            {
                Slot slot = new 鬼ContainerCreative.CreativeSlot((Slot)container.inventorySlots.get(j), j);
    ...
    public void handleMouseInput() throws IOException
    {
        ...
        {
            int j = ((鬼ContainerCreative.ContainerCreative)this.inventorySlots).itemList.size() / 9 - 5;
            ...
            ((鬼ContainerCreative.ContainerCreative)this.inventorySlots).scrollTo(this.currentScroll);
        }
    }
    ...
    protected void renderToolTip(ItemStack stack, int x, int y)
    {
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex())
        {
            List<String> list = stack.getTooltip(this.mc.宇轩游玩者, this.mc.游戏一窝.advancedItemTooltips);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        for (CreativeTabs creativetabs1 : CreativeTabs.creativeTabArray)
        {
            this.mc.得到手感经理().绑定手感(creativeInventoryTabs);
        ...
        {
            鬼Inventory.drawEntityOnScreen(this.guiLeft + 43, this.guiTop + 45, 20, (float)(this.guiLeft + 43 - mouseX), (float)(this.guiTop + 45 - 30 - mouseY), this.mc.宇轩游玩者);
        }
    }
    ...
    static class ContainerCreative extends Container
    {
        ...
        public ContainerCreative(实体Player p_i1086_1_)
        {
            ...
            for (int i = 0; i < 5; ++i)
            {
                for (int j = 0; j < 9; ++j)
                {
                    this.addSlotToContainer(new Slot(鬼ContainerCreative.field_147060_v, i * 9 + j, 9 + j * 18, 18 + i * 18));
                }
            }
        ...
        public void scrollTo(float p_148329_1_)
        {
            ...
            for (int k = 0; k < 5; ++k)
            {
                for (int l = 0; l < 9; ++l)
                {
                    ...
                    {
                        鬼ContainerCreative.field_147060_v.setInventorySlotContents(l + k * 9, (ItemStack)this.itemList.get(i1));
                    }
                    else
                    {
                        鬼ContainerCreative.field_147060_v.setInventorySlotContents(l + k * 9, (ItemStack)null);
                    }
                }
            }
        }
