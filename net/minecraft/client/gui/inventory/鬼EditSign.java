...
public class 鬼EditSign extends 鬼Screen
{
    ...
    public 鬼EditSign(TileEntitySign teSign)
    {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.doneBtn = new 鬼Button(0, this.width / 2 - 100, this.height / 4 + 120, I18n.format("gui.done", new Object[0])));
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        this.tileSign.signText[this.editLine] = new 交流组分文本(s);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        光照状态经理.推黑客帝国();
        光照状态经理.理解((float)(this.width / 2), 0.0F, 50.0F);
        float f = 93.75F;
        光照状态经理.障眼物(-f, -f, -f);
