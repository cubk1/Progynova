...
public class 鬼Stats extends 鬼Screen implements IProgressMeter
{
    ...
    private 鬼Stats.StatsGeneral generalStats;
    private 鬼Stats.StatsItem itemStats;
    private 鬼Stats.StatsBlock blockStats;
    private 鬼Stats.StatsMobsList mobStats;
    private StatFileWriter field_146546_t;
    private GuiSlot displaySlot;
    private boolean doesGuiPauseGame = true;

    public 鬼Stats(鬼Screen p_i1071_1_, StatFileWriter p_i1071_2_)
    {
    ...
    {
        this.generalStats = new 鬼Stats.StatsGeneral(this.mc);
        this.generalStats.registerScrollButtons(1, 1);
        this.itemStats = new 鬼Stats.StatsItem(this.mc);
        this.itemStats.registerScrollButtons(1, 1);
        this.blockStats = new 鬼Stats.StatsBlock(this.mc);
        this.blockStats.registerScrollButtons(1, 1);
        this.mobStats = new 鬼Stats.StatsMobsList(this.mc);
        this.mobStats.registerScrollButtons(1, 1);
    }

    public void createButtons()
    {
        this.buttonList.add(new 鬼Button(0, this.width / 2 + 4, this.height - 28, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new 鬼Button(1, this.width / 2 - 160, this.height - 52, 80, 20, I18n.format("stat.generalButton", new Object[0])));
        鬼Button guibutton;
        this.buttonList.add(guibutton = new 鬼Button(2, this.width / 2 - 80, this.height - 52, 80, 20, I18n.format("stat.blocksButton", new Object[0])));
        鬼Button guibutton1;
        this.buttonList.add(guibutton1 = new 鬼Button(3, this.width / 2, this.height - 52, 80, 20, I18n.format("stat.itemsButton", new Object[0])));
        鬼Button guibutton2;
        this.buttonList.add(guibutton2 = new 鬼Button(4, this.width / 2 + 80, this.height - 52, 80, 20, I18n.format("stat.mobsButton", new Object[0])));
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected Stats(我的手艺 mcIn)
        {
            super(mcIn, 鬼Stats.this.width, 鬼Stats.this.height, 32, 鬼Stats.this.height - 64, 20);
        ...
        {
            鬼Stats.this.drawDefaultBackground();
        }
        ...
        protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_)
        {
            ...
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 115 - 18, p_148129_2_ + 1, 0, 0);
            }
            else
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 115 - 18, p_148129_2_ + 1, 0, 18);
            }

            if (this.field_148218_l == 1)
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 165 - 18, p_148129_2_ + 1, 0, 0);
            }
            else
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 165 - 18, p_148129_2_ + 1, 0, 18);
            }

            if (this.field_148218_l == 2)
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 215 - 18, p_148129_2_ + 1, 0, 0);
            }
            else
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 215 - 18, p_148129_2_ + 1, 0, 18);
            }
            ...
            if (this.field_148217_o != -1)
            {
                ...
                鬼Stats.this.drawSprite(p_148129_1_ + i, p_148129_2_ + 1, j, 0);
            }
        }
        ...
        protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_)
        {
            if (p_148209_1_ != null)
            {
                String s = p_148209_1_.format(鬼Stats.this.field_146546_t.readStat(p_148209_1_));
                鬼Stats.this.drawString(鬼Stats.this.fontRendererObj, s, p_148209_2_ - 鬼Stats.this.fontRendererObj.getStringWidth(s), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
            }
            else
            {
                String s1 = "-";
                鬼Stats.this.drawString(鬼Stats.this.fontRendererObj, s1, p_148209_2_ - 鬼Stats.this.fontRendererObj.getStringWidth(s1), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
            }
        }
    ...
    class StatsBlock extends 鬼Stats.Stats
    {
        public StatsBlock(我的手艺 mcIn)
        {
            super(mcIn);
            ...
            for (StatCrafting statcrafting : StatList.objectMineStats)
            {
                ...
                if (鬼Stats.this.field_146546_t.readStat(statcrafting) > 0)
                {
                    flag = true;
                }
                else if (StatList.objectUseStats[i] != null && 鬼Stats.this.field_146546_t.readStat(StatList.objectUseStats[i]) > 0)
                {
                    flag = true;
                }
                else if (StatList.objectCraftStats[i] != null && 鬼Stats.this.field_146546_t.readStat(StatList.objectCraftStats[i]) > 0)
                {
                    flag = true;
                }
            ...
            this.statSorter = new Comparator<StatCrafting>()
            {
                public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_)
                {
                    ...
                    if (statbase != null || statbase1 != null)
                    {
                        ...
                        int l = 鬼Stats.this.field_146546_t.readStat(statbase);
                        int i1 = 鬼Stats.this.field_146546_t.readStat(statbase1);
        ...
        protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_)
        {
            ...
            if (this.field_148218_l == 0)
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 115 - 18 + 1, p_148129_2_ + 1 + 1, 18, 18);
            }
            else
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 115 - 18, p_148129_2_ + 1, 18, 18);
            }

            if (this.field_148218_l == 1)
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 165 - 18 + 1, p_148129_2_ + 1 + 1, 36, 18);
            }
            else
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 165 - 18, p_148129_2_ + 1, 36, 18);
            }

            if (this.field_148218_l == 2)
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 215 - 18 + 1, p_148129_2_ + 1 + 1, 54, 18);
            }
            else
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 215 - 18, p_148129_2_ + 1, 54, 18);
            }
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            鬼Stats.this.drawStatsScreen(p_180791_2_ + 40, p_180791_3_, item);
    ...
    {
        public StatsGeneral(我的手艺 mcIn)
        {
            super(mcIn, 鬼Stats.this.width, 鬼Stats.this.height, 32, 鬼Stats.this.height - 64, 10);
            this.setShowSelectionBox(false);
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            鬼Stats.this.drawString(鬼Stats.this.fontRendererObj, statbase.getStatName().getUnformattedText(), p_180791_2_ + 2, p_180791_3_ + 1, entryID % 2 == 0 ? 16777215 : 9474192);
            String s = statbase.format(鬼Stats.this.field_146546_t.readStat(statbase));
            鬼Stats.this.drawString(鬼Stats.this.fontRendererObj, s, p_180791_2_ + 2 + 213 - 鬼Stats.this.fontRendererObj.getStringWidth(s), p_180791_3_ + 1, entryID % 2 == 0 ? 16777215 : 9474192);
        }
    }

    class StatsItem extends 鬼Stats.Stats
    {
        public StatsItem(我的手艺 mcIn)
        {
            super(mcIn);
            this.statsHolder = Lists.<StatCrafting>newArrayList();
            ...
            for (StatCrafting statcrafting : StatList.itemStats)
            {
                ...
                else if (StatList.objectBreakStats[i] != null && 鬼Stats.this.field_146546_t.readStat(StatList.objectBreakStats[i]) > 0)
                {
                    flag = true;
                }
                else if (StatList.objectCraftStats[i] != null && 鬼Stats.this.field_146546_t.readStat(StatList.objectCraftStats[i]) > 0)
        ...
        protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_)
        {
            ...
            if (this.field_148218_l == 0)
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 115 - 18 + 1, p_148129_2_ + 1 + 1, 72, 18);
            }
            else
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 115 - 18, p_148129_2_ + 1, 72, 18);
            }

            if (this.field_148218_l == 1)
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 165 - 18 + 1, p_148129_2_ + 1 + 1, 18, 18);
            }
            else
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 165 - 18, p_148129_2_ + 1, 18, 18);
            }

            if (this.field_148218_l == 2)
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 215 - 18 + 1, p_148129_2_ + 1 + 1, 36, 18);
            }
            else
            {
                鬼Stats.this.drawSprite(p_148129_1_ + 215 - 18, p_148129_2_ + 1, 36, 18);
            }
        }
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        public StatsMobsList(我的手艺 mcIn)
        {
            super(mcIn, 鬼Stats.this.width, 鬼Stats.this.height, 32, 鬼Stats.this.height - 64, 鬼Stats.this.fontRendererObj.FONT_HEIGHT * 4);
            this.setShowSelectionBox(false);

            for (EntityList.EntityEggInfo entitylist$entityegginfo : EntityList.entityEggs.values())
            {
                if (鬼Stats.this.field_146546_t.readStat(entitylist$entityegginfo.field_151512_d) > 0 || 鬼Stats.this.field_146546_t.readStat(entitylist$entityegginfo.field_151513_e) > 0)
                {
        ...
        protected int getContentHeight()
        {
            return this.getSize() * 鬼Stats.this.fontRendererObj.FONT_HEIGHT * 4;
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            int i = 鬼Stats.this.field_146546_t.readStat(entitylist$entityegginfo.field_151512_d);
            int j = 鬼Stats.this.field_146546_t.readStat(entitylist$entityegginfo.field_151513_e);
            ...
            鬼Stats.this.drawString(鬼Stats.this.fontRendererObj, s, p_180791_2_ + 2 - 10, p_180791_3_ + 1, 16777215);
            鬼Stats.this.drawString(鬼Stats.this.fontRendererObj, s1, p_180791_2_ + 2, p_180791_3_ + 1 + 鬼Stats.this.fontRendererObj.FONT_HEIGHT, i == 0 ? 6316128 : 9474192);
            鬼Stats.this.drawString(鬼Stats.this.fontRendererObj, s2, p_180791_2_ + 2, p_180791_3_ + 1 + 鬼Stats.this.fontRendererObj.FONT_HEIGHT * 2, j == 0 ? 6316128 : 9474192);
        }
    }
}
