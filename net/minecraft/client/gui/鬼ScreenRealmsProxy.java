...
public class 鬼ScreenRealmsProxy extends 鬼Screen
{
    private RealmsScreen field_154330_a;

    public 鬼ScreenRealmsProxy(RealmsScreen p_i1087_1_)
    {
        this.field_154330_a = p_i1087_1_;
        super.buttonList = Collections.<鬼Button>synchronizedList(Lists.<鬼Button>newArrayList());
    }
    ...
    public final void actionPerformed(鬼Button button) throws IOException
    {
        this.field_154330_a.buttonClicked(((鬼ButtonRealmsProxy)button).getRealmsButton());
    }
    ...
    public List<RealmsButton> func_154320_j()
    {
        ...
        for (鬼Button guibutton : super.buttonList)
        {
            list.add(((鬼ButtonRealmsProxy)guibutton).getRealmsButton());
        }
