...
public class 鬼RenameWorld extends 鬼Screen
{
    private 鬼Screen parentScreen;
    private 鬼TextField field_146583_f;
    private final String saveName;

    public 鬼RenameWorld(鬼Screen parentScreenIn, String saveNameIn)
    {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new 鬼Button(0, this.width / 2 - 100, this.height / 4 + 96 + 12, I18n.format("selectWorld.renameButton", new Object[0])));
        ...
        this.field_146583_f = new 鬼TextField(2, this.fontRendererObj, this.width / 2 - 100, 60, 200, 20);
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        ((鬼Button)this.buttonList.get(0)).enabled = this.field_146583_f.getText().trim().length() > 0;
