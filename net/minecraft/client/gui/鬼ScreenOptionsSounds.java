...
{
    private final 鬼Screen field_146505_f;
    private final GameSettings game_settings_4;
    protected String field_146507_a = "Options";
    private String field_146508_h;

    public 鬼ScreenOptionsSounds(鬼Screen p_i45025_1_, GameSettings p_i45025_2_)
    {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new 鬼ScreenOptionsSounds.Button(SoundCategory.MASTER.getCategoryId(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), SoundCategory.MASTER, true));
        i = i + 2;
        ...
        for (SoundCategory soundcategory : SoundCategory.values())
        {
            ...
            {
                this.buttonList.add(new 鬼ScreenOptionsSounds.Button(soundcategory.getCategoryId(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), soundcategory, false));
                ++i;
            }
        }
    ...
    class Button extends 鬼Button
    {
        ...
        public Button(int p_i45024_2_, int p_i45024_3_, int p_i45024_4_, SoundCategory p_i45024_5_, boolean p_i45024_6_)
        {
            ...
            this.displayString = this.field_146152_s + ": " + 鬼ScreenOptionsSounds.this.getSoundVolume(p_i45024_5_);
            this.field_146156_o = 鬼ScreenOptionsSounds.this.game_settings_4.getSoundLevel(p_i45024_5_);
        }
        ...
        protected void mouseDragged(我的手艺 mc, int mouseX, int mouseY)
        {
            if (this.visible)
            {
                if (this.field_146155_p)
                {
                    ...
                    mc.游戏一窝.setSoundLevel(this.field_146153_r, this.field_146156_o);
                    mc.游戏一窝.saveOptions();
                    this.displayString = this.field_146152_s + ": " + 鬼ScreenOptionsSounds.this.getSoundVolume(this.field_146153_r);
                }
