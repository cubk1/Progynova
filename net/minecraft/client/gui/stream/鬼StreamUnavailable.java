...
public class 鬼StreamUnavailable extends 鬼Screen
{
    ...
    private final 鬼StreamUnavailable.Reason field_152326_h;
    private final List<ChatComponentTranslation> field_152327_i;
    private final List<String> field_152323_r;

    public 鬼StreamUnavailable(鬼Screen p_i1070_1_, 鬼StreamUnavailable.Reason p_i1070_2_)
    {
        this(p_i1070_1_, p_i1070_2_, (List<ChatComponentTranslation>)null);
    }

    public 鬼StreamUnavailable(鬼Screen parentScreenIn, 鬼StreamUnavailable.Reason p_i46311_2_, List<ChatComponentTranslation> p_i46311_3_)
    {
    ...
    public void initGui()
    {
        ...
        {
            this.buttonList.add(new 鬼Button(0, this.width / 2 - 155, this.height - 50, 150, 20, I18n.format("gui.cancel", new Object[0])));
            this.buttonList.add(new 鬼Button(1, this.width / 2 - 155 + 160, this.height - 50, 150, 20, I18n.format(this.field_152326_h.func_152559_b().getFormattedText(), new Object[0])));
        }
        else
        {
            this.buttonList.add(new 鬼Button(0, this.width / 2 - 75, this.height - 50, 150, 20, I18n.format("gui.cancel", new Object[0])));
        }
    }
    ...
    public static void func_152321_a(鬼Screen p_152321_0_)
    {
        我的手艺 宇轩的世界 = 我的手艺.得到我的手艺();
        IStream istream = 宇轩的世界.getTwitchStream();
        ...
        if (!OpenGlHelper.framebufferSupported)
        {
            ...
            宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.NO_FBO, list));
        }
        else if (istream instanceof NullStream)
        {
            ...
            {
                宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.LIBRARY_ARCH_MISMATCH));
            }
            else
            {
                宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.LIBRARY_FAILURE));
            }
        }
        else if (!istream.func_152928_D() && istream.func_152912_E() == ErrorCode.TTV_EC_OS_TOO_OLD)
        {
            ...
            {
                case WINDOWS:
                    宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.UNSUPPORTED_OS_WINDOWS));
                    break;

                case OSX:
                    宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.UNSUPPORTED_OS_MAC));
                    break;

                default:
                    宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.UNSUPPORTED_OS_OTHER));
            }
        }
        else if (!宇轩的世界.getTwitchDetails().containsKey("twitch_access_token"))
        {
            if (宇轩的世界.getSession().getSessionType() == Session.Type.LEGACY)
            {
                宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.ACCOUNT_NOT_MIGRATED));
            }
            else
            {
                宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.ACCOUNT_NOT_BOUND));
            }
        }
        else if (!istream.func_152913_F())
        {
            ...
            {
                case INVALID_TOKEN:
                    宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.FAILED_TWITCH_AUTH));
                    break;

                case ERROR:
                default:
                    宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.FAILED_TWITCH_AUTH_ERROR));
            }
        }
        else if (istream.func_152912_E() != null)
        {
            ...
            宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.INITIALIZATION_FAILURE, list1));
        }
        else
        {
            宇轩的世界.displayGuiScreen(new 鬼StreamUnavailable(p_152321_0_, 鬼StreamUnavailable.Reason.UNKNOWN));
        }
    }
