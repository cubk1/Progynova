...
public class 鬼StreamOptions extends 鬼Screen
{
    ...
    public 鬼StreamOptions(鬼Screen parentScreenIn, GameSettings p_i1073_2_)
    {
    ...
    public void initGui()
    {
        ...
        for (GameSettings.Options gamesettings$options : field_152312_a)
        {
            ...
            {
                this.buttonList.add(new 鬼OptionButton(gamesettings$options.returnEnumOrdinal(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), gamesettings$options, this.field_152318_h.getKeyBinding(gamesettings$options)));
            }
        ...
        for (GameSettings.Options gamesettings$options1 : field_152316_f)
        {
            ...
            {
                this.buttonList.add(new 鬼OptionSlider(gamesettings$options1.returnEnumOrdinal(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), gamesettings$options1));
            }
            else
            {
                this.buttonList.add(new 鬼OptionButton(gamesettings$options1.returnEnumOrdinal(), this.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), gamesettings$options1, this.field_152318_h.getKeyBinding(gamesettings$options1)));
            }

            ++i;
        }

        this.buttonList.add(new 鬼Button(200, this.width / 2 - 155, this.height / 6 + 168, 150, 20, I18n.format("gui.done", new Object[0])));
        鬼Button guibutton = new 鬼Button(201, this.width / 2 + 5, this.height / 6 + 168, 150, 20, I18n.format("options.stream.ingestSelection", new Object[0]));
    ...
    protected void actionPerformed(鬼Button button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button instanceof 鬼OptionSlider)
            {
            ...
            {
                this.mc.游戏一窝.saveOptions();
                this.mc.displayGuiScreen(new 鬼IngestServers(this));
            }
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            this.drawCenteredString(this.fontRendererObj, 枚举聊天格式.RED + I18n.format("options.stream.changes", new Object[0]), this.width / 2, 20 + this.fontRendererObj.FONT_HEIGHT, 16777215);
        }
