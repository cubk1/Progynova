...
public class 鬼TwitchUserMode extends 鬼Screen
{
    private static final 枚举聊天格式 field_152331_a = 枚举聊天格式.DARK_GREEN;
    private static final 枚举聊天格式 field_152335_f = 枚举聊天格式.RED;
    private static final 枚举聊天格式 field_152336_g = 枚举聊天格式.DARK_PURPLE;
    ...
    public 鬼TwitchUserMode(IStream streamIn, ChatUserInfo p_i1064_2_)
    {
        this.stream = streamIn;
        this.field_152337_h = p_i1064_2_;
        this.field_152338_i = new 交流组分文本(p_i1064_2_.displayName);
    ...
    public static List<IChatComponent> func_152328_a(Set<ChatUserMode> p_152328_0_, Set<ChatUserSubscription> p_152328_1_, IStream p_152328_2_)
    {
        ...
        for (ChatUserMode chatusermode : p_152328_0_)
        {
            ...
            {
                IChatComponent ichatcomponent1 = new 交流组分文本("- ");
        ...
        for (ChatUserSubscription chatusersubscription : p_152328_1_)
        {
            ...
            {
                IChatComponent ichatcomponent3 = new 交流组分文本("- ");
    ...
    public void initGui()
    {
        int i = this.width / 3;
        int j = i - 130;
        this.buttonList.add(new 鬼Button(1, i * 0 + j / 2, this.height - 70, 130, 20, I18n.format("stream.userinfo.timeout", new Object[0])));
        this.buttonList.add(new 鬼Button(0, i * 1 + j / 2, this.height - 70, 130, 20, I18n.format("stream.userinfo.ban", new Object[0])));
        this.buttonList.add(new 鬼Button(2, i * 2 + j / 2, this.height - 70, 130, 20, I18n.format("stream.userinfo.mod", new Object[0])));
        this.buttonList.add(new 鬼Button(5, i * 0 + j / 2, this.height - 45, 130, 20, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(new 鬼Button(3, i * 1 + j / 2, this.height - 45, 130, 20, I18n.format("stream.userinfo.unban", new Object[0])));
        this.buttonList.add(new 鬼Button(4, i * 2 + j / 2, this.height - 45, 130, 20, I18n.format("stream.userinfo.unmod", new Object[0])));
        int k = 0;
