...
public class 鬼ScreenAddServer extends 鬼Screen
{
    private final 鬼Screen parentScreen;
    private final ServerData serverData;
    private 鬼TextField serverIPField;
    private 鬼TextField serverNameField;
    private 鬼Button serverResourcePacks;
    ...
    public 鬼ScreenAddServer(鬼Screen p_i1033_1_, ServerData p_i1033_2_)
    {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new 鬼Button(0, this.width / 2 - 100, this.height / 4 + 96 + 18, I18n.format("addServer.add", new Object[0])));
        this.buttonList.add(new 鬼Button(1, this.width / 2 - 100, this.height / 4 + 120 + 18, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(this.serverResourcePacks = new 鬼Button(2, this.width / 2 - 100, this.height / 4 + 72, I18n.format("addServer.resourcePack", new Object[0]) + ": " + this.serverData.getResourceMode().getMotd().getFormattedText()));
        this.serverNameField = new 鬼TextField(0, this.fontRendererObj, this.width / 2 - 100, 66, 200, 20);
        this.serverNameField.setFocused(true);
        this.serverNameField.setText(this.serverData.serverName);
        this.serverIPField = new 鬼TextField(1, this.fontRendererObj, this.width / 2 - 100, 106, 200, 20);
        this.serverIPField.setMaxStringLength(128);
        this.serverIPField.setText(this.serverData.serverIP);
        this.serverIPField.setValidator(this.field_181032_r);
        ((鬼Button)this.buttonList.get(0)).enabled = this.serverIPField.getText().length() > 0 && this.serverIPField.getText().split(":").length > 0 && this.serverNameField.getText().length() > 0;
    }
