...
public class 鬼MemoryErrorScreen extends 鬼Screen
{
    public void initGui()
    {
        this.buttonList.clear();
        this.buttonList.add(new 鬼OptionButton(0, this.width / 2 - 155, this.height / 4 + 120 + 12, I18n.format("gui.toTitle", new Object[0])));
        this.buttonList.add(new 鬼OptionButton(1, this.width / 2 - 155 + 160, this.height / 4 + 120 + 12, I18n.format("menu.quit", new Object[0])));
    }
