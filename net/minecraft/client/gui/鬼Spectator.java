...
public class 鬼Spectator extends 鬼 implements ISpectatorMenuRecipient
{
    ...
    {
        this.field_175270_h = 我的手艺.getSystemTime();
    ...
    {
        long i = this.field_175270_h - 我的手艺.getSystemTime() + 5000L;
    ...
    protected void func_175258_a(ScaledResolution p_175258_1_, float p_175258_2_, int p_175258_3_, float p_175258_4_, SpectatorDetails p_175258_5_)
    {
        ...
        光照状态经理.色彩(1.0F, 1.0F, 1.0F, p_175258_2_);
        this.field_175268_g.得到手感经理().绑定手感(field_175267_f);
    ...
    {
        this.field_175268_g.得到手感经理().绑定手感(field_175269_a);

        if (p_175266_5_ != SpectatorMenu.field_178657_a)
        {
            int i = (int)(p_175266_4_ * 255.0F);
            光照状态经理.推黑客帝国();
            光照状态经理.理解((float)p_175266_2_, p_175266_3_, 0.0F);
            float f = p_175266_5_.func_178662_A_() ? 1.0F : 0.25F;
            光照状态经理.色彩(f, f, f, p_175266_4_);
            p_175266_5_.func_178663_a(f, i);
            光照状态经理.流行音乐黑客帝国();
            String s = String.valueOf((Object)GameSettings.getKeyDisplayString(this.field_175268_g.游戏一窝.keyBindsHotbar[p_175266_1_].getKeyCode()));
