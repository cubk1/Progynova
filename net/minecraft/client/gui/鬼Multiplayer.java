...
public class 鬼Multiplayer extends 鬼Screen implements GuiYesNoCallback
{
    ...
    private 鬼Button btnEditServer;
    private 鬼Button btnSelectServer;
    private 鬼Button btnDeleteServer;
    ...
    public 鬼Multiplayer(鬼Screen parentScreen)
    {
    ...
    {
        this.buttonList.add(this.btnEditServer = new 鬼Button(7, this.width / 2 - 154, this.height - 28, 70, 20, I18n.format("selectServer.edit", new Object[0])));
        this.buttonList.add(this.btnDeleteServer = new 鬼Button(2, this.width / 2 - 74, this.height - 28, 70, 20, I18n.format("selectServer.delete", new Object[0])));
        this.buttonList.add(this.btnSelectServer = new 鬼Button(1, this.width / 2 - 154, this.height - 52, 100, 20, I18n.format("selectServer.select", new Object[0])));
        this.buttonList.add(new 鬼Button(4, this.width / 2 - 50, this.height - 52, 100, 20, I18n.format("selectServer.direct", new Object[0])));
        this.buttonList.add(new 鬼Button(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.format("selectServer.add", new Object[0])));
        this.buttonList.add(new 鬼Button(8, this.width / 2 + 4, this.height - 28, 70, 20, I18n.format("selectServer.refresh", new Object[0])));
        this.buttonList.add(new 鬼Button(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20, I18n.format("gui.cancel", new Object[0])));
        ...
        if (button.enabled)
        {
            ...
            if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal)
            {
                ...
                if (s4 != null)
                {
                    ...
                    鬼YesNo guiyesno = new 鬼YesNo(this, s, s1, s2, s3, this.serverListSelector.func_148193_k());
            ...
            else if (button.id == 4)
            {
                ...
                this.mc.displayGuiScreen(new 鬼ScreenServerList(this, this.selectedServer = new ServerData(I18n.format("selectServer.defaultName", new Object[0]), "", false)));
            }
            else if (button.id == 3)
            {
                this.addingServer = true;
                this.mc.displayGuiScreen(new 鬼ScreenAddServer(this, this.selectedServer = new ServerData(I18n.format("selectServer.defaultName", new Object[0]), "", false)));
            }
            else if (button.id == 7 && guilistextended$iguilistentry instanceof ServerListEntryNormal)
            {
                ...
                this.mc.displayGuiScreen(new 鬼ScreenAddServer(this, this.selectedServer));
            }
            else if (button.id == 0)
            {
    ...
    {
        this.mc.displayGuiScreen(new 鬼Multiplayer(this.parentScreen));
    }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        else
        {
            if (i >= 0)
            {
                ...
                {
                    this.actionPerformed((鬼Button)this.buttonList.get(2));
                }
            }
            else
            {
    ...
    {
        this.mc.displayGuiScreen(new 鬼Connecting(this, this.mc, server));
    }
