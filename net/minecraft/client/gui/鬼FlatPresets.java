...
public class 鬼FlatPresets extends 鬼Screen
{
    private static final List<鬼FlatPresets.LayerItem> FLAT_WORLD_PRESETS = Lists.<鬼FlatPresets.LayerItem>newArrayList();
    private final 鬼CreateFlatWorld parentScreen;
    private String presetsTitle;
    private String presetsShare;
    private String field_146436_r;
    private 鬼FlatPresets.ListSlot field_146435_s;
    private 鬼Button field_146434_t;
    private 鬼TextField field_146433_u;

    public 鬼FlatPresets(鬼CreateFlatWorld p_i46318_1_)
    {
    ...
    public void initGui()
    {
        ...
        this.field_146433_u = new 鬼TextField(2, this.fontRendererObj, 50, 40, this.width - 100, 20);
        this.field_146435_s = new 鬼FlatPresets.ListSlot();
        this.field_146433_u.setMaxStringLength(1230);
        this.field_146433_u.setText(this.parentScreen.func_146384_e());
        this.buttonList.add(this.field_146434_t = new 鬼Button(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
    ...
    private static void func_175354_a(String p_175354_0_, Item p_175354_1_, int p_175354_2_, BiomeGenBase p_175354_3_, List<String> p_175354_4_, FlatLayerInfo... p_175354_5_)
    {
        ...
        FLAT_WORLD_PRESETS.add(new 鬼FlatPresets.LayerItem(p_175354_1_, p_175354_2_, p_175354_0_, flatgeneratorinfo.toString()));
    }
    ...
    class ListSlot extends GuiSlot
    {
        ...
        public ListSlot()
        {
            super(鬼FlatPresets.this.mc, 鬼FlatPresets.this.width, 鬼FlatPresets.this.height, 80, 鬼FlatPresets.this.height - 37, 24);
        }
        ...
        private void func_178054_a(int p_178054_1_, int p_178054_2_, Item p_178054_3_, int p_178054_4_)
        {
            ...
            鬼FlatPresets.this.itemRender.renderItemIntoGUI(new ItemStack(p_178054_3_, 1, p_178054_4_), p_178054_1_ + 2, p_178054_2_ + 2);
        ...
        private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_)
        {
            ...
            worldrenderer.pos((double)(p_148171_1_ + 0), (double)(p_148171_2_ + 18), (double) 鬼FlatPresets.this.zLevel).tex((double)((float)(p_148171_3_ + 0) * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148171_1_ + 18), (double)(p_148171_2_ + 18), (double) 鬼FlatPresets.this.zLevel).tex((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148171_1_ + 18), (double)(p_148171_2_ + 0), (double) 鬼FlatPresets.this.zLevel).tex((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)(p_148171_4_ + 0) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148171_1_ + 0), (double)(p_148171_2_ + 0), (double) 鬼FlatPresets.this.zLevel).tex((double)((float)(p_148171_3_ + 0) * 0.0078125F), (double)((float)(p_148171_4_ + 0) * 0.0078125F)).endVertex();
            tessellator.draw();
        }

        protected int getSize()
        {
            return 鬼FlatPresets.FLAT_WORLD_PRESETS.size();
        }

        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY)
        {
            this.field_148175_k = slotIndex;
            鬼FlatPresets.this.func_146426_g();
            鬼FlatPresets.this.field_146433_u.setText(((鬼FlatPresets.LayerItem) 鬼FlatPresets.FLAT_WORLD_PRESETS.get(鬼FlatPresets.this.field_146435_s.field_148175_k)).field_148233_c);
        }
        ...
        {
            鬼FlatPresets.LayerItem guiflatpresets$layeritem = (鬼FlatPresets.LayerItem) 鬼FlatPresets.FLAT_WORLD_PRESETS.get(entryID);
            ...
            鬼FlatPresets.this.fontRendererObj.drawString(guiflatpresets$layeritem.field_148232_b, p_180791_2_ + 18 + 5, p_180791_3_ + 6, 16777215);
        }
    }
}
