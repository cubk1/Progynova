...
public class SpectatorMenu
{
    ...
    static class EndSpectatorObject implements ISpectatorMenuObject
    {
        ...
        public IChatComponent getSpectatorName()
        {
            return new 交流组分文本("Close menu");
        }

        public void func_178663_a(float p_178663_1_, int alpha)
        {
            我的手艺.得到我的手艺().得到手感经理().绑定手感(鬼Spectator.field_175269_a);
            鬼.绘制模态矩形以自定义大小纹理(0, 0, 128.0F, 0.0F, 16, 16, 256.0F, 256.0F);
        }
    ...
    static class MoveMenuObject implements ISpectatorMenuObject
    {
        ...
        public IChatComponent getSpectatorName()
        {
            return this.field_178666_a < 0 ? new 交流组分文本("Previous Page") : new 交流组分文本("Next Page");
        }
        ...
        public void func_178663_a(float p_178663_1_, int alpha)
        {
            ...
            {
                鬼.绘制模态矩形以自定义大小纹理(0, 0, 144.0F, 0.0F, 16, 16, 256.0F, 256.0F);
            }
            else
            {
                鬼.绘制模态矩形以自定义大小纹理(0, 0, 160.0F, 0.0F, 16, 16, 256.0F, 256.0F);
            }
        }
