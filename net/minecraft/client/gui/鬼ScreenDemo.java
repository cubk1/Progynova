...
public class 鬼ScreenDemo extends 鬼Screen
{
    ...
    public void initGui()
    {
        ...
        int i = -16;
        this.buttonList.add(new 鬼Button(1, this.width / 2 - 116, this.height / 2 + 62 + i, 114, 20, I18n.format("demo.help.buy", new Object[0])));
        this.buttonList.add(new 鬼Button(2, this.width / 2 + 2, this.height / 2 + 62 + i, 114, 20, I18n.format("demo.help.later", new Object[0])));
    }
    ...
    public void drawDefaultBackground()
    {
        ...
        this.mc.得到手感经理().绑定手感(field_146348_f);
