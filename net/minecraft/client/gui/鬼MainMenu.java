...
public class 鬼MainMenu extends 鬼Screen implements GuiYesNoCallback
{
    ...
    private 鬼Button buttonResetDemo;
    ...
    private 鬼Button modButton;
    private 鬼Screen modUpdateNotification;
    ...
    public 鬼MainMenu()
    {
        ...
        try
        {
            ...
            bufferedreader = new BufferedReader(new InputStreamReader(我的手艺.得到我的手艺().getResourceManager().getResource(splashTexts).getInputStream(), Charsets.UTF_8));
            String s;
    ...
    {
        return 我的手艺.得到我的手艺().游戏一窝.getOptionOrdinalValue(GameSettings.Options.REALMS_NOTIFICATIONS) && this.field_183503_M != null;
    }
    ...
    public void initGui()
    {
        ...
        this.backgroundTexture = this.mc.得到手感经理().getDynamicTextureLocation("background", this.viewportTexture);
        ...
        this.buttonList.add(new 鬼Button(0, this.width / 2 - 100, j + 72 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new 鬼Button(4, this.width / 2 + 2, j + 72 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
        this.buttonList.add(new 鬼ButtonLanguage(5, this.width / 2 - 124, j + 72 + 12));
        ...
        synchronized (this.threadLock)
        {
            ...
            this.field_92021_u = ((鬼Button)this.buttonList.get(0)).yPosition - 24;
        ...
        if (我的手艺.得到我的手艺().游戏一窝.getOptionOrdinalValue(GameSettings.Options.REALMS_NOTIFICATIONS) && !this.field_183502_L)
        {
    ...
    {
        this.buttonList.add(new 鬼Button(1, this.width / 2 - 100, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new 鬼Button(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer", new Object[0])));

        if (Reflector.GuiModList_Constructor.exists())
        {
            this.buttonList.add(this.realmsButton = new 鬼Button(14, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("menu.online", new Object[0]).replace("Minecraft", "").trim()));
            this.buttonList.add(this.modButton = new 鬼Button(6, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("fml.menu.mods", new Object[0])));
        }
        else
        {
            this.buttonList.add(this.realmsButton = new 鬼Button(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online", new Object[0])));
        }
    }

    private void addDemoButtons(int p_73972_1_, int p_73972_2_)
    {
        this.buttonList.add(new 鬼Button(11, this.width / 2 - 100, p_73972_1_, I18n.format("menu.playdemo", new Object[0])));
        this.buttonList.add(this.buttonResetDemo = new 鬼Button(12, this.width / 2 - 100, p_73972_1_ + p_73972_2_ * 1, I18n.format("menu.resetdemo", new Object[0])));
    ...
    protected void actionPerformed(鬼Button button) throws IOException
    {
        ...
        if (button.id == 5)
        {
            this.mc.displayGuiScreen(new 鬼Language(this, this.mc.游戏一窝, this.mc.getLanguageManager()));
        }

        if (button.id == 1)
        {
            this.mc.displayGuiScreen(new 鬼SelectWorld(this));
        }

        if (button.id == 2)
        {
            this.mc.displayGuiScreen(new 鬼Multiplayer(this));
        }
        ...
        {
            this.mc.displayGuiScreen((鬼Screen)Reflector.newInstance(Reflector.GuiModList_Constructor, new Object[] {this}));
        }
        ...
        if (button.id == 12)
        {
            ...
            if (worldinfo != null)
            {
                鬼YesNo guiyesno = 鬼SelectWorld.makeDeleteWorldYesNo(this, worldinfo.getWorldName(), 12);
    ...
    private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_)
    {
        ...
        for (int k = 0; k < j; ++k)
        {
            ...
            float f2 = 0.0F;
            光照状态经理.理解(f, f1, f2);
            光照状态经理.辐射(MathHelper.sin(((float)this.panoramaTimer + p_73970_3_) / 400.0F) * 25.0F + 20.0F, 1.0F, 0.0F, 0.0F);
            光照状态经理.辐射(-((float)this.panoramaTimer + p_73970_3_) * 0.1F, 0.0F, 1.0F, 0.0F);
            ...
            for (int l = 0; l < 6; ++l)
            {
                ...
                this.mc.得到手感经理().绑定手感(aresourcelocation[l]);
    ...
    {
        this.mc.得到手感经理().绑定手感(this.backgroundTexture);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.得到手感经理().绑定手感(minecraftTitleTextures);
        光照状态经理.色彩(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        光照状态经理.推黑客帝国();
        光照状态经理.理解((float)(this.width / 2 + 90), 70.0F, 0.0F);
        光照状态经理.辐射(-20.0F, 0.0F, 0.0F, 1.0F);
        float f = 1.8F - MathHelper.abs(MathHelper.sin((float)(我的手艺.getSystemTime() % 1000L) / 1000.0F * (float)Math.PI * 2.0F) * 0.1F);
        ...
        if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0)
        {
            ...
            this.drawString(this.fontRendererObj, this.openGLWarning2, (this.width - this.field_92024_r) / 2, ((鬼Button)this.buttonList.get(0)).yPosition - 12, -1);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        synchronized (this.threadLock)
        {
            ...
            {
                鬼ConfirmOpenLink guiconfirmopenlink = new 鬼ConfirmOpenLink(this, this.openGLWarningLink, 13, true);
