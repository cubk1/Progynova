...
public class 鬼CommandBlock extends 鬼Screen
{
    private static final Logger field_146488_a = LogManager.getLogger();
    private 鬼TextField commandTextField;
    private 鬼TextField previousOutputTextField;
    private final CommandBlockLogic localCommandBlock;
    private 鬼Button doneBtn;
    private 鬼Button cancelBtn;
    private 鬼Button field_175390_s;
    private boolean field_175389_t;

    public 鬼CommandBlock(CommandBlockLogic p_i45032_1_)
    {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.doneBtn = new 鬼Button(0, this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(this.cancelBtn = new 鬼Button(1, this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(this.field_175390_s = new 鬼Button(4, this.width / 2 + 150 - 20, 150, 20, 20, "O"));
        this.commandTextField = new 鬼TextField(2, this.fontRendererObj, this.width / 2 - 150, 50, 300, 20);
        this.commandTextField.setMaxStringLength(32767);
        this.commandTextField.setFocused(true);
        this.commandTextField.setText(this.localCommandBlock.getCommand());
        this.previousOutputTextField = new 鬼TextField(3, this.fontRendererObj, this.width / 2 - 150, 150, 276, 20);
