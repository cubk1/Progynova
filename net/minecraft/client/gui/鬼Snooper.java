...
public class 鬼Snooper extends 鬼Screen
{
    private final 鬼Screen field_146608_a;
    ...
    private 鬼Snooper.List field_146606_s;
    private 鬼Button field_146605_t;

    public 鬼Snooper(鬼Screen p_i1061_1_, GameSettings p_i1061_2_)
    {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_146605_t = new 鬼Button(1, this.width / 2 - 152, this.height - 30, 150, 20, this.game_settings_2.getKeyBinding(GameSettings.Options.SNOOPER_ENABLED)));
        this.buttonList.add(new 鬼Button(2, this.width / 2 + 2, this.height - 30, 150, 20, I18n.format("gui.done", new Object[0])));
        ...
        this.field_146606_s = new 鬼Snooper.List();
    }
    ...
    class List extends GuiSlot
    {
        public List()
        {
            super(鬼Snooper.this.mc, 鬼Snooper.this.width, 鬼Snooper.this.height, 80, 鬼Snooper.this.height - 40, 鬼Snooper.this.fontRendererObj.FONT_HEIGHT + 1);
        }

        protected int getSize()
        {
            return 鬼Snooper.this.field_146604_g.size();
        }
        ...
        {
            鬼Snooper.this.fontRendererObj.drawString((String) 鬼Snooper.this.field_146604_g.get(entryID), 10, p_180791_3_, 16777215);
            鬼Snooper.this.fontRendererObj.drawString((String) 鬼Snooper.this.field_146609_h.get(entryID), 230, p_180791_3_, 16777215);
        }
