...
public class 鬼CustomizeWorldScreen extends 鬼Screen implements 鬼Slider.FormatHelper, GuiPageButtonList.GuiResponder
{
    private 鬼CreateWorld field_175343_i;
    ...
    private 鬼Button field_175348_s;
    private 鬼Button field_175347_t;
    private 鬼Button field_175346_u;
    private 鬼Button field_175345_v;
    private 鬼Button field_175344_w;
    private 鬼Button field_175352_x;
    private 鬼Button field_175351_y;
    private 鬼Button field_175350_z;
    ...
    public 鬼CustomizeWorldScreen(鬼Screen p_i45521_1_, String p_i45521_2_)
    {
        this.field_175343_i = (鬼CreateWorld)p_i45521_1_;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_175345_v = new 鬼Button(302, 20, 5, 80, 20, I18n.format("createWorld.customize.custom.prev", new Object[0])));
        this.buttonList.add(this.field_175344_w = new 鬼Button(303, this.width - 100, 5, 80, 20, I18n.format("createWorld.customize.custom.next", new Object[0])));
        this.buttonList.add(this.field_175346_u = new 鬼Button(304, this.width / 2 - 187, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.defaults", new Object[0])));
        this.buttonList.add(this.field_175347_t = new 鬼Button(301, this.width / 2 - 92, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.randomize", new Object[0])));
        this.buttonList.add(this.field_175350_z = new 鬼Button(305, this.width / 2 + 3, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.presets", new Object[0])));
        this.buttonList.add(this.field_175348_s = new 鬼Button(300, this.width / 2 + 98, this.height - 27, 90, 20, I18n.format("gui.done", new Object[0])));
        this.field_175346_u.enabled = this.field_175338_A;
        this.field_175352_x = new 鬼Button(306, this.width / 2 - 55, 160, 50, 20, I18n.format("gui.yes", new Object[0]));
        this.field_175352_x.visible = false;
        this.buttonList.add(this.field_175352_x);
        this.field_175351_y = new 鬼Button(307, this.width / 2 + 5, 160, 50, 20, I18n.format("gui.no", new Object[0]));
    ...
    public void func_175319_a(int p_175319_1_, String p_175319_2_)
    {
        ...
        if (f1 != f && f != 0.0F)
        {
            ((鬼TextField)this.field_175349_r.func_178061_c(p_175319_1_)).setText(this.func_175330_b(p_175319_1_, f1));
        }

        ((鬼Slider)this.field_175349_r.func_178061_c(p_175319_1_ - 132 + 100)).func_175218_a(f1, false);
    ...
    public void onTick(int id, float value)
    {
        ...
        if (id >= 100 && id < 116)
        {
            鬼 鬼 = this.field_175349_r.func_178061_c(id - 100 + 132);

            if (鬼 != null)
            {
                ((鬼TextField) 鬼).setText(this.func_175330_b(id, value));
            }
        }
            ...
            switch (button.id)
            {
                ...
                case 301:
                    for (int i = 0; i < this.field_175349_r.getSize(); ++i)
                    {
                        ...
                        鬼 鬼 = guipagebuttonlist$guientry.func_178022_a();

                        if (鬼 instanceof 鬼Button)
                        {
                            鬼Button guibutton = (鬼Button) 鬼;

                            if (guibutton instanceof 鬼Slider)
                            {
                                float f = ((鬼Slider)guibutton).func_175217_d() * (0.75F + this.random.nextFloat() * 0.5F) + (this.random.nextFloat() * 0.1F - 0.05F);
                                ((鬼Slider)guibutton).func_175219_a(MathHelper.clamp_float(f, 0.0F, 1.0F));
                            }
                            else if (guibutton instanceof 鬼ListButton)
                            {
                                ((鬼ListButton)guibutton).func_175212_b(this.random.nextBoolean());
                            }
                        }

                        鬼 鬼1 = guipagebuttonlist$guientry.func_178021_b();

                        if (鬼1 instanceof 鬼Button)
                        {
                            鬼Button guibutton1 = (鬼Button) 鬼1;

                            if (guibutton1 instanceof 鬼Slider)
                            {
                                float f1 = ((鬼Slider)guibutton1).func_175217_d() * (0.75F + this.random.nextFloat() * 0.5F) + (this.random.nextFloat() * 0.1F - 0.05F);
                                ((鬼Slider)guibutton1).func_175219_a(MathHelper.clamp_float(f1, 0.0F, 1.0F));
                            }
                            else if (guibutton1 instanceof 鬼ListButton)
                            {
                                ((鬼ListButton)guibutton1).func_175212_b(this.random.nextBoolean());
                            }
                        }
                    }
                ...
                case 305:
                    this.mc.displayGuiScreen(new 鬼ScreenCustomizePresets(this));
                    break;
    ...
    private void func_175331_h() throws IOException
    {
        ...
        {
            case 300:
                this.actionPerformed((鬼ListButton)this.field_175349_r.func_178061_c(300));
                break;
    ...
    {
        鬼 鬼 = this.field_175349_r.func_178056_g();
        ...
        if (鬼 instanceof 鬼TextField)
        {
            ...
            if (鬼Screen.isShiftKeyDown())
            {
                ...
                if (鬼Screen.isCtrlKeyDown())
                {
                    f *= 0.1F;
                }
            }
            else if (鬼Screen.isCtrlKeyDown())
            {
                f = p_175327_1_ * 10.0F;

                if (鬼Screen.isAltKeyDown())
                {
                    f *= 10.0F;
                }
            }

            鬼TextField guitextfield = (鬼TextField) 鬼;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.field_175339_B != 0)
        {
            ...
            this.mc.得到手感经理().绑定手感(optionsBackground);
