...
public class 鬼ButtonRealmsProxy extends 鬼Button
{
    private RealmsButton realmsButton;

    public 鬼ButtonRealmsProxy(RealmsButton realmsButtonIn, int buttonId, int x, int y, String text)
    {
        super(buttonId, x, y, text);
        this.realmsButton = realmsButtonIn;
    }

    public 鬼ButtonRealmsProxy(RealmsButton realmsButtonIn, int buttonId, int x, int y, String text, int widthIn, int heightIn)
    {
    ...
    public void mouseDragged(我的手艺 mc, int mouseX, int mouseY)
    {
