...
public class 鬼ErrorScreen extends 鬼Screen
{
    private String field_146313_a;
    private String field_146312_f;

    public 鬼ErrorScreen(String p_i46319_1_, String p_i46319_2_)
    {
    ...
    {
        super.initGui();
        this.buttonList.add(new 鬼Button(0, this.width / 2 - 100, 140, I18n.format("gui.cancel", new Object[0])));
    }
