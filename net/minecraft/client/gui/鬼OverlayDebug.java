...
public class 鬼OverlayDebug extends 鬼
{
    ...
    {
        return this.mc.宇轩游玩者.hasReducedDebug() || this.mc.游戏一窝.reducedDebugInfo;
    }
    ...
    protected List<String> call()
    {
        ...
        {
            return Lists.newArrayList(new String[] {"Minecraft 1.8.9 (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.宇轩の世界.getDebugLoadedEntities() + s1, this.mc.宇轩の世界.getProviderName(), "", String.format("Chunk-relative: %d %d %d", new Object[]{Integer.valueOf(blockpos.getX() & 15), Integer.valueOf(blockpos.getY() & 15), Integer.valueOf(blockpos.getZ() & 15)})});
        }
        else
        {
            ...
            {
                Chunk chunk = this.mc.宇轩の世界.getChunkFromBlockCoords(blockpos);
                list.add("Biome: " + chunk.getBiome(blockpos, this.mc.宇轩の世界.getWorldChunkManager()).biomeName);
                ...
                DifficultyInstance difficultyinstance = this.mc.宇轩の世界.getDifficultyForLocation(blockpos);
                ...
                list.add(String.format("Local Difficulty: %.2f (Day %d)", new Object[] {Float.valueOf(difficultyinstance.getAdditionalDifficulty()), Long.valueOf(this.mc.宇轩の世界.getWorldTime() / 24000L)}));
            }
    ...
    protected List<String> getDebugInfoRight()
    {
        ...
        else
        {
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null)
            {
                ...
                {
                    iblockstate = iblockstate.getBlock().getActualState(iblockstate, this.mc.宇轩の世界, blockpos);
                }
