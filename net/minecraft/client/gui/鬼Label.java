...
public class 鬼Label extends 鬼
{
    ...
    public 鬼Label(FontRenderer fontRendererObj, int p_i45540_2_, int p_i45540_3_, int p_i45540_4_, int p_i45540_5_, int p_i45540_6_, int p_i45540_7_)
    {
    ...
    public 鬼Label setCentered()
    {
        this.centered = true;
        return this;
    }

    public void drawLabel(我的手艺 mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            光照状态经理.启用混合品();
    ...
    protected void drawLabelBackground(我的手艺 mcIn, int p_146160_2_, int p_146160_3_)
    {
