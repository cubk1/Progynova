...
import net.minecraft.client.gui.鬼NewChat;
...
public class GameSettings
{
    ...
    public 键入绑定 键入绑定前 = new 键入绑定("key.forward", 17, "key.categories.movement");
    public 键入绑定 键入绑定左 = new 键入绑定("key.left", 30, "key.categories.movement");
    public 键入绑定 键入绑定后 = new 键入绑定("key.back", 31, "key.categories.movement");
    public 键入绑定 键入绑定右 = new 键入绑定("key.right", 32, "key.categories.movement");
    public 键入绑定 keyBindJump = new 键入绑定("key.jump", 57, "key.categories.movement");
    public 键入绑定 keyBindSneak = new 键入绑定("key.sneak", 42, "key.categories.movement");
    public 键入绑定 keyBindSprint = new 键入绑定("key.sprint", 29, "key.categories.movement");
    public 键入绑定 keyBindInventory = new 键入绑定("key.inventory", 18, "key.categories.inventory");
    public 键入绑定 keyBindUseItem = new 键入绑定("key.use", -99, "key.categories.gameplay");
    public 键入绑定 keyBindDrop = new 键入绑定("key.drop", 16, "key.categories.gameplay");
    public 键入绑定 keyBindAttack = new 键入绑定("key.attack", -100, "key.categories.gameplay");
    public 键入绑定 keyBindPickBlock = new 键入绑定("key.pickItem", -98, "key.categories.gameplay");
    public 键入绑定 keyBindChat = new 键入绑定("key.chat", 20, "key.categories.multiplayer");
    public 键入绑定 keyBindPlayerList = new 键入绑定("key.playerlist", 15, "key.categories.multiplayer");
    public 键入绑定 keyBindCommand = new 键入绑定("key.command", 53, "key.categories.multiplayer");
    public 键入绑定 keyBindScreenshot = new 键入绑定("key.screenshot", 60, "key.categories.misc");
    public 键入绑定 keyBindTogglePerspective = new 键入绑定("key.togglePerspective", 63, "key.categories.misc");
    public 键入绑定 keyBindSmoothCamera = new 键入绑定("key.smoothCamera", 0, "key.categories.misc");
    public 键入绑定 keyBindFullscreen = new 键入绑定("key.fullscreen", 87, "key.categories.misc");
    public 键入绑定 keyBindSpectatorOutlines = new 键入绑定("key.spectatorOutlines", 0, "key.categories.misc");
    public 键入绑定 keyBindStreamStartStop = new 键入绑定("key.streamStartStop", 64, "key.categories.stream");
    public 键入绑定 keyBindStreamPauseUnpause = new 键入绑定("key.streamPauseUnpause", 65, "key.categories.stream");
    public 键入绑定 keyBindStreamCommercials = new 键入绑定("key.streamCommercial", 0, "key.categories.stream");
    public 键入绑定 keyBindStreamToggleMic = new 键入绑定("key.streamToggleMic", 0, "key.categories.stream");
    public 键入绑定[] keyBindsHotbar = new 键入绑定[] {new 键入绑定("key.hotbar.1", 2, "key.categories.inventory"), new 键入绑定("key.hotbar.2", 3, "key.categories.inventory"), new 键入绑定("key.hotbar.3", 4, "key.categories.inventory"), new 键入绑定("key.hotbar.4", 5, "key.categories.inventory"), new 键入绑定("key.hotbar.5", 6, "key.categories.inventory"), new 键入绑定("key.hotbar.6", 7, "key.categories.inventory"), new 键入绑定("key.hotbar.7", 8, "key.categories.inventory"), new 键入绑定("key.hotbar.8", 9, "key.categories.inventory"), new 键入绑定("key.hotbar.9", 10, "key.categories.inventory")};
    public 键入绑定[] 键入绑定s;
    protected 我的手艺 mc;
    ...
    public 键入绑定 ofKeyBindZoom;
    private File optionsFileOF;

    public GameSettings(我的手艺 mcIn, File optionsFileIn)
    {
        this.键入绑定s = (键入绑定[])((键入绑定[])ArrayUtils.addAll(new 键入绑定[] {this.keyBindAttack, this.keyBindUseItem, this.键入绑定前, this.键入绑定左, this.键入绑定后, this.键入绑定右, this.keyBindJump, this.keyBindSneak, this.keyBindSprint, this.keyBindDrop, this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand, this.keyBindScreenshot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindStreamStartStop, this.keyBindStreamPauseUnpause, this.keyBindStreamCommercials, this.keyBindStreamToggleMic, this.keyBindFullscreen, this.keyBindSpectatorOutlines}, this.keyBindsHotbar));
        ...
        this.ofKeyBindZoom = new 键入绑定("of.key.zoom", 46, "key.categories.misc");
        this.键入绑定s = (键入绑定[])((键入绑定[])ArrayUtils.add(this.键入绑定s, this.ofKeyBindZoom));
        KeyUtils.fixKeyConflicts(this.键入绑定s, new 键入绑定[] {this.ofKeyBindZoom});
    ...
    public void setOptionValue(GameSettings.Options settingsOption, int value)
    {
        ...
        if (settingsOption == GameSettings.Options.FORCE_UNICODE_FONT)
        {
            ...
            this.mc.字体渲染员.setUnicodeFlag(this.mc.getLanguageManager().isCurrentLocaleUnicode() || this.forceUnicodeFont);
        }
    ...
    public String getKeyBinding(GameSettings.Options settingOption)
    {
        ...
        else
        {
            ...
            if (settingOption.getEnumFloat())
            {
                ...
                return settingOption == GameSettings.Options.MIPMAP_LEVELS && (double)f1 >= 4.0D ? s1 + Lang.get("of.general.max") : (settingOption == GameSettings.Options.SENSITIVITY ? (f == 0.0F ? s1 + I18n.format("options.sensitivity.min", new Object[0]) : (f == 1.0F ? s1 + I18n.format("options.sensitivity.max", new Object[0]) : s1 + (int)(f * 200.0F) + "%")) : (settingOption == GameSettings.Options.FOV ? (f1 == 70.0F ? s1 + I18n.format("options.fov.min", new Object[0]) : (f1 == 110.0F ? s1 + I18n.format("options.fov.max", new Object[0]) : s1 + (int)f1)) : (settingOption == GameSettings.Options.FRAMERATE_LIMIT ? (f1 == settingOption.valueMax ? s1 + I18n.format("options.framerateLimit.max", new Object[0]) : s1 + (int)f1 + " fps") : (settingOption == GameSettings.Options.RENDER_CLOUDS ? (f1 == settingOption.valueMin ? s1 + I18n.format("options.cloudHeight.min", new Object[0]) : s1 + ((int)f1 + 128)) : (settingOption == GameSettings.Options.GAMMA ? (f == 0.0F ? s1 + I18n.format("options.gamma.min", new Object[0]) : (f == 1.0F ? s1 + I18n.format("options.gamma.max", new Object[0]) : s1 + "+" + (int)(f * 100.0F) + "%")) : (settingOption == GameSettings.Options.SATURATION ? s1 + (int)(f * 400.0F) + "%" : (settingOption == GameSettings.Options.CHAT_OPACITY ? s1 + (int)(f * 90.0F + 10.0F) + "%" : (settingOption == GameSettings.Options.CHAT_HEIGHT_UNFOCUSED ? s1 + 鬼NewChat.calculateChatboxHeight(f) + "px" : (settingOption == GameSettings.Options.CHAT_HEIGHT_FOCUSED ? s1 + 鬼NewChat.calculateChatboxHeight(f) + "px" : (settingOption == GameSettings.Options.CHAT_WIDTH ? s1 + 鬼NewChat.calculateChatboxWidth(f) + "px" : (settingOption == GameSettings.Options.RENDER_DISTANCE ? s1 + (int)f1 + " chunks" : (settingOption == GameSettings.Options.MIPMAP_LEVELS ? (f1 == 0.0F ? s1 + I18n.format("options.off", new Object[0]) : s1 + (int)f1) : (settingOption == GameSettings.Options.STREAM_FPS ? s1 + TwitchStream.formatStreamFps(f) + " fps" : (settingOption == GameSettings.Options.STREAM_KBPS ? s1 + TwitchStream.formatStreamKbps(f) + " Kbps" : (settingOption == GameSettings.Options.STREAM_BYTES_PER_PIXEL ? s1 + String.format("%.3f bpp", new Object[] {Float.valueOf(TwitchStream.formatStreamBps(f))}): (f == 0.0F ? s1 + I18n.format("options.off", new Object[0]) : s1 + (int)(f * 100.0F) + "%"))))))))))))))));
            }
                ...
                if (this.optionsFile.exists())
                {
                    ...
                    while ((s = bufferedreader.readLine()) != null)
                    {
                        try
                        {
                            ...
                            for (键入绑定 keybinding : this.键入绑定s)
                            {
                    ...
                    键入绑定.resetKeyBindingArrayAndHash();
    ...
    public void sendSettingsToServer()
    {
        if (this.mc.宇轩游玩者 != null)
        {
            ...
            this.mc.宇轩游玩者.sendQueue.addToSendQueue(new C15PacketClientSettings(this.language, this.renderDistanceChunks, this.chatVisibility, this.chatColours, i));
        }
    }
    ...
    private void setOptionValueOF(GameSettings.Options p_setOptionValueOF_1_, int p_setOptionValueOF_2_)
    {
        ...
        if (p_setOptionValueOF_1_ == GameSettings.Options.CUSTOM_FONTS)
        {
            ...
            this.mc.字体渲染员.onResourceManagerReload(Config.getResourceManager());
    ...
    private void updateWaterOpacity()
    {
        ...
        ClearWater.updateWaterOpacity(this, this.mc.宇轩の世界);
    }
