...
public class ModelHorse extends ModelBase
{
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        {
            光照状态经理.推黑客帝国();
            光照状态经理.障眼物(f1, 0.5F + f1 * 0.5F, f1);
            光照状态经理.理解(0.0F, 0.95F * (1.0F - f1), 0.0F);
        }
        ...
        if (!flag)
        {
            ...
            光照状态经理.推黑客帝国();
            光照状态经理.障眼物(f1, f1, f1);
            光照状态经理.理解(0.0F, 1.35F * (1.0F - f1), 0.0F);
        }
        ...
        if (!flag)
        {
            ...
            {
                光照状态经理.理解(0.0F, 0.9F * (1.0F - f1) * f + 1.35F * (1.0F - f1) * (1.0F - f), 0.15F * (1.0F - f1) * f);
            }
        }
