...
public class ModelRenderer
{
    ...
    public void render(float p_78785_1_)
    {
        if (!this.isHidden && this.showModel)
        {
            ...
            if (this.textureLocation != null && !this.renderGlobal.renderOverlayDamaged)
            {
                ...
                i = 光照状态经理.getBoundTexture();
                Config.getTextureManager().绑定手感(this.textureLocation);
            }
            ...
            光照状态经理.理解(this.offsetX, this.offsetY, this.offsetZ);
            ...
            if (this.rotateAngleX == 0.0F && this.rotateAngleY == 0.0F && this.rotateAngleZ == 0.0F)
            {
                if (this.rotationPointX == 0.0F && this.rotationPointY == 0.0F && this.rotationPointZ == 0.0F)
                {
                    if (flag)
                    {
                        光照状态经理.障眼物(this.scaleX, this.scaleY, this.scaleZ);
                    }

                    光照状态经理.callList(this.displayList);
                    ...
                    if (flag)
                    {
                        光照状态经理.障眼物(1.0F / this.scaleX, 1.0F / this.scaleY, 1.0F / this.scaleZ);
                    }
                }
                else
                {
                    光照状态经理.理解(this.rotationPointX * p_78785_1_, this.rotationPointY * p_78785_1_, this.rotationPointZ * p_78785_1_);
            ...
            else
            {
                ...
                {
                    光照状态经理.辐射(this.rotateAngleZ * (180F / (float)Math.PI), 0.0F, 0.0F, 1.0F);
                }

                if (this.rotateAngleY != 0.0F)
                {
                    光照状态经理.辐射(this.rotateAngleY * (180F / (float)Math.PI), 0.0F, 1.0F, 0.0F);
                }

                if (this.rotateAngleX != 0.0F)
                {
                    光照状态经理.辐射(this.rotateAngleX * (180F / (float)Math.PI), 1.0F, 0.0F, 0.0F);
                }
    ...
    public void renderWithRotation(float p_78791_1_)
    {
        if (!this.isHidden && this.showModel)
        {
            ...
            boolean flag = this.scaleX != 1.0F || this.scaleY != 1.0F || this.scaleZ != 1.0F;
            光照状态经理.推黑客帝国();
            光照状态经理.理解(this.rotationPointX * p_78791_1_, this.rotationPointY * p_78791_1_, this.rotationPointZ * p_78791_1_);
    ...
    public void postRender(float scale)
    {
        if (!this.isHidden && this.showModel)
        {
            ...
            if (this.rotateAngleX == 0.0F && this.rotateAngleY == 0.0F && this.rotateAngleZ == 0.0F)
            {
                if (this.rotationPointX != 0.0F || this.rotationPointY != 0.0F || this.rotationPointZ != 0.0F)
                {
                    光照状态经理.理解(this.rotationPointX * scale, this.rotationPointY * scale, this.rotationPointZ * scale);
                }
            }
            else
            {
