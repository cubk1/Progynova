...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public EntityPlayerSP(我的手艺 mcIn, World worldIn, NetHandlerPlayClient netHandler, StatFileWriter statFile)
    {
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            if (this.isRiding())
            {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(this.旋转侧滑, this.rotationPitch, this.onGround));
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        {
            final 宇轩の玩家更新事件 pre = new 宇轩の玩家更新事件(this.旋转侧滑, this.rotationPitch, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.onGround);
            ...
            if (this.ridingEntity == null)
            {
                ...
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.通便X, -999.0D, this.通便Z, yaw, pitch, ground));
                flag2 = false;
            }
