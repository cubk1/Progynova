...
public class JsonBlendingMode
{
    ...
    public void func_148109_a()
    {
        if (!this.equals(field_148118_a))
        {
            ...
            {
                光照状态经理.tryBlendFuncSeparate(this.field_148116_b, this.field_148114_d, this.field_148117_c, this.field_148115_e);
            }
            else
            {
                光照状态经理.正常工作(this.field_148116_b, this.field_148114_d);
            }
        }
    }
