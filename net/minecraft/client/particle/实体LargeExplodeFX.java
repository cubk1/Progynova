...
public class 实体LargeExplodeFX extends 实体FX
{
    private static final 图像位置 EXPLOSION_TEXTURE = new 图像位置("textures/entity/explosion.png");
    ...
    protected 实体LargeExplodeFX(TextureManager renderEngine, World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double p_i1213_9_, double p_i1213_11_, double p_i1213_13_)
    {
    ...
    public void renderParticle(WorldRenderer worldRendererIn, 实体 实体In, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ)
    {
        ...
        if (i <= 15)
        {
            this.theRenderEngine.绑定手感(EXPLOSION_TEXTURE);
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            return new 实体LargeExplodeFX(我的手艺.得到我的手艺().得到手感经理(), worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
        }
    }
}
