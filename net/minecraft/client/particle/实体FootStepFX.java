...
public class 实体FootStepFX extends 实体FX
{
    ...
    protected 实体FootStepFX(TextureManager currentFootStepsIn, World worldIn, double xCoordIn, double yCoordIn, double zCoordIn)
    {
    ...
    public void renderParticle(WorldRenderer worldRendererIn, 实体 实体In, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ)
    {
        ...
        float f2 = 0.125F;
        float f3 = (float)(this.X坐标 - interpPosX);
        float f4 = (float)(this.Y坐标 - interpPosY);
        float f5 = (float)(this.Z坐标 - interpPosZ);
        float f6 = this.worldObj.getLightBrightness(new 阻止位置(this));
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            return new 实体FootStepFX(我的手艺.得到我的手艺().得到手感经理(), worldIn, xCoordIn, yCoordIn, zCoordIn);
        }
    }
}
