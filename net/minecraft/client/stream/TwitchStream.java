...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream
{
    ...
    private final IChatComponent twitchComponent = new 交流组分文本("Twitch");
    ...
    public TwitchStream(我的手艺 mcIn, final Property streamProperty)
    {
        this.mc = mcIn;
    ...
    {
        int i = this.mc.游戏一窝.streamChatEnabled;
    ...
    public void func_152922_k()
    {
        if (this.broadcastController.isBroadcasting() && !this.broadcastController.isBroadcastPaused())
        {
            ...
            if (flag)
            {
                ...
                光照状态经理.推黑客帝国();
                光照状态经理.loadIdentity();
                光照状态经理.ortho(0.0D, (double)this.framebuffer.framebufferWidth, (double)this.framebuffer.framebufferHeight, 0.0D, 1000.0D, 3000.0D);
                光照状态经理.matrixMode(5888);
                光照状态经理.推黑客帝国();
                光照状态经理.loadIdentity();
                光照状态经理.理解(0.0F, 0.0F, -2000.0F);
                光照状态经理.色彩(1.0F, 1.0F, 1.0F, 1.0F);
                光照状态经理.viewport(0, 0, this.framebuffer.framebufferWidth, this.framebuffer.framebufferHeight);
                光照状态经理.启用手感();
    ...
    public void updateStreamVolume()
    {
        ...
        {
            float f = this.mc.游戏一窝.streamGameVolume;
            boolean flag = this.field_152962_n || f <= 0.0F;
            this.broadcastController.setPlaybackDeviceVolume(flag ? 0.0F : f);
            this.broadcastController.setRecordingDeviceVolume(this.func_152929_G() ? 0.0F : this.mc.游戏一窝.streamMicVolume);
        }
    }
    ...
    public void func_152893_b(ErrorCode p_152893_1_)
    {
        ...
        this.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(new 交流组分文本("Issue streaming frame: " + p_152893_1_ + " (" + ErrorCode.getString(p_152893_1_) + ")"), 2);
    }
    ...
    public void func_180605_a(String p_180605_1_, ChatRawMessage[] p_180605_2_)
    {
        for (ChatRawMessage chatrawmessage : p_180605_2_)
        {
            ...
            if (this.func_176028_a(chatrawmessage.modes, chatrawmessage.subscriptions, this.mc.游戏一窝.streamChatUserFilter))
            {
                ...
                IChatComponent ichatcomponent2 = new 交流组分文本("");
                ichatcomponent2.appendSibling(new ChatComponentTranslation("stream.userinfo.chatTooltip", new Object[0]));

                for (IChatComponent ichatcomponent3 : 鬼TwitchUserMode.func_152328_a(chatrawmessage.modes, chatrawmessage.subscriptions, (IStream)null))
                {
    ...
    {
        boolean flag = this.mc.游戏一窝.streamMicToggleBehavior == 1;
        return this.field_152962_n || this.mc.游戏一窝.streamMicVolume <= 0.0F || flag != this.field_152963_o;
    }
