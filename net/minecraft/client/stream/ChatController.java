...
public class ChatController
{
    ...
    {
        return this.func_175987_a(p_152986_1_);
    }
    ...
    public class ChatChannelListener implements IChatChannelListener
    {
        ...
        public void func_176032_a(String p_176032_1_)
        {
            ...
            else
            {
                if (this.field_176045_e.size() > 0)
                {
                    ...
                    this.field_176045_e.removeIf(chatrawmessage -> chatrawmessage.userName.equals(p_176032_1_));
                }

                if (this.field_176042_f.size() > 0)
                {

                    this.field_176042_f.removeIf(chattokenizedmessage -> chattokenizedmessage.displayName.equals(p_176032_1_));
                }
            }
        ...
        {
            for (ChatUserInfo chatUserInfo : p_chatChannelUserChangeCallback_3_) {
                int j = this.field_176044_d.indexOf(chatUserInfo);
