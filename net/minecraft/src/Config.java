...
import net.optifine.gui.鬼Message;
...
public class Config
{
    ...
    private static 我的手艺 宇轩的世界 = 我的手艺.得到我的手艺();
    ...
    {
        return 宇轩的世界.getRenderItem().modelManager;
    }
    ...
    public static 我的手艺 getMinecraft()
    {
        return 宇轩的世界;
    }
    ...
    {
        if (宇轩的世界.getResourcePackRepository() == null)
        {
            return "";
        }
        else
    ...
    public static DefaultResourcePack getDefaultResourcePack()
    {
        if (defaultResourcePackLazy == null)
        {
            ...
            defaultResourcePackLazy = (DefaultResourcePack)Reflector.getFieldValue(宇轩的世界, Reflector.Minecraft_defaultResourcePack);
    ...
    public static void checkGlError(String p_checkGlError_0_)
    {
        ...
        if (i != 0 && GlErrors.isEnabled(i))
        {
            ...
            if (isShowGlErrors() && TimedEvent.isActive("ShowGlError", 10000L))
            {
                ...
                宇轩的世界.ingameGUI.getChatGUI().printChatMessage(new 交流组分文本(s2));
            }
        }
    }
    ...
    public static void checkDisplaySettings()
    {
        ...
        if (i > 0)
        {
            ...
            if (!宇轩的世界.isRunningOnMac && getDefaultResourcePack() != null)
            {
    ...
    public static void checkDisplayMode()
    {
        try
        {
            if (宇轩的世界.isFullScreen())
            {
                ...
                宇轩的世界.displayWidth = Display.getDisplayMode().getWidth();
                宇轩的世界.displayHeight = Display.getDisplayMode().getHeight();

                if (宇轩的世界.displayWidth <= 0)
                {
                    宇轩的世界.displayWidth = 1;
                }

                if (宇轩的世界.displayHeight <= 0)
                {
                    宇轩的世界.displayHeight = 1;
                }
    ...
    public static void updateFramebufferSize()
    {
        ...
        宇轩的世界.loadingScreen = new LoadingScreenRenderer(宇轩的世界);
    }
    ...
    {
        int i = 宇轩的世界.getDebugFPS();
        String s = getUpdates(宇轩的世界.debug);
        int j = 宇轩的世界.renderGlobal.getCountActiveRenderers();
    ...
    {
        if (宇轩的世界.debug == mcDebugLast)
        {
            return fpsMinLast;
        }
        else
        {
            mcDebugLast = 宇轩的世界.debug;
            FrameTimer frametimer = 宇轩的世界.getFrameTimer();
    ...
    {
        鬼Message guimessage = new 鬼Message(宇轩的世界.currentScreen, p_showGuiMessage_0_, p_showGuiMessage_1_);
        宇轩的世界.displayGuiScreen(guimessage);
    }
    ...
    {
        return 宇轩的世界.getIntegratedServer() == null ? false : 宇轩的世界.isIntegratedServerRunning();
    }
