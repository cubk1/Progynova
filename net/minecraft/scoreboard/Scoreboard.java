    ...
    public static String getObjectiveDisplaySlot(int p_96517_0_)
    {
        switch (p_96517_0_)
        {
            ...
            default:
                ...
                {
                    枚举聊天格式 enumchatformatting = 枚举聊天格式.func_175744_a(p_96517_0_ - 3);

                    if (enumchatformatting != null && enumchatformatting != 枚举聊天格式.RESET)
                    {
    ...
    public static int getObjectiveDisplaySlotNumber(String p_96537_0_)
    {
        ...
        else
        {
            if (p_96537_0_.startsWith("sidebar.team."))
            {
                ...
                枚举聊天格式 enumchatformatting = 枚举聊天格式.getValueByName(s);
