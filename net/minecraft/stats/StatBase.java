...
public class StatBase
{
    ...
    public IChatComponent getStatName()
    {
        ...
        ichatcomponent.getChatStyle().setChatHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_ACHIEVEMENT, new 交流组分文本(this.statId)));
    ...
    public IChatComponent createChatComponent()
    {
        ...
        IChatComponent ichatcomponent1 = (new 交流组分文本("[")).appendSibling(ichatcomponent).appendText("]");
