...
public class ItemArmorStand extends Item
{
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    List<实体> list = worldIn.getEntitiesWithinAABBExcludingEntity((实体)null, AxisAlignedBB.fromBounds(d0, d1, d2, d0 + 1.0D, d1 + 2.0D, d2 + 1.0D));
                    ...
                    else
                    {
                        if (!worldIn.isRemote)
                        {
                            ...
                            实体ArmorStand entityarmorstand = new 实体ArmorStand(worldIn, d0 + 0.5D, d1, d2 + 0.5D);
                            float f = (float)MathHelper.floor_float((MathHelper.wrapAngleTo180_float(playerIn.旋转侧滑 - 180.0F) + 22.5F) / 45.0F) * 45.0F;
    ...
    private void applyRandomRotations(实体ArmorStand armorStand, Random rand)
    {
