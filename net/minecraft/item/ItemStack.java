...
public final class ItemStack
{
    ...
    {
        交流组分文本 chatcomponenttext = new 交流组分文本(this.getDisplayName());
        ...
        IChatComponent ichatcomponent = (new 交流组分文本("[")).appendSibling(chatcomponenttext).appendText("]");

        if (this.item != null)
        {
            NBTTagCompound nbttagcompound = new NBTTagCompound();
            this.writeToNBT(nbttagcompound);
            ichatcomponent.getChatStyle().setChatHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_ITEM, new 交流组分文本(nbttagcompound.toString())));
