package rip.liyuxuan.主播为什么要用你的IQ换我破端子的源码.module.implement.visual;
...
import rip.liyuxuan.主播为什么要用你的IQ换我破端子的源码.module.option.implement.宇轩の小连击;
import rip.liyuxuan.主播为什么要用你的IQ换我破端子的源码.module.option.implement.宇轩の布尔;
import rip.liyuxuan.主播为什么要用你的IQ换我破端子的源码.util.render.渲染的功能;
...
public class 宇轩的头部显示 extends 宇轩の模块 {
    ...
    public static 宇轩の布尔 DEOBF = new 宇轩の布尔("DEOBF?","DEOBF?",真);
    public static 宇轩の布尔 瞎几把转 = new 宇轩の布尔("瞎几把转","让宇轩美照瞎几把转", 假,DEOBF::获取设置);
    public static 宇轩の小连击 宇轩美照颜色模式 = new 宇轩の小连击("宇轩美照颜色模式","宇轩美照颜色显示模式","抽风","固定","彩虹");
    public static Color 李宇轩喜欢的颜色 = 宇轩の模块种类.values()[new Random().nextInt(宇轩の模块种类.values().length)].获取宇轩颜色();
    ...
    public static void 宇轩渲染事件() {
        ...
        switch (宇轩美照颜色模式.获取设置()){
            ...
            case "彩虹":{
                Color 彩虹 = new Color(Color.HSBtoRGB((float)((double)我D世界.宇轩游玩者.已存在的刻度 / 50.0 + Math.sin((double)0 / 50.0 * 1.6)) % 1.0f, 1f, 1.0f));
                颜色 = 彩虹.getRGB();
            }
        }
